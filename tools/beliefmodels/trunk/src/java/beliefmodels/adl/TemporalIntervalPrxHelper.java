...
public final class TemporalIntervalPrxHelper extends Ice.ObjectPrxHelperBase implements TemporalIntervalPrx
{
    ...
    checkedCast(Ice.ObjectPrx __obj)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::beliefmodels::adl::TemporalInterval"))
                {
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::beliefmodels::adl::TemporalInterval", __ctx))
                {
                    TemporalIntervalPrxHelper __h = new TemporalIntervalPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::beliefmodels::adl::TemporalInterval"))
                {
                    TemporalIntervalPrxHelper __h = new TemporalIntervalPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::beliefmodels::adl::TemporalInterval", __ctx))
                {
                    TemporalIntervalPrxHelper __h = new TemporalIntervalPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
