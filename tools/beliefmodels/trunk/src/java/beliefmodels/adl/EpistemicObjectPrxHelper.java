...
public final class EpistemicObjectPrxHelper extends Ice.ObjectPrxHelperBase implements EpistemicObjectPrx
{
    ...
    checkedCast(Ice.ObjectPrx __obj)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::beliefmodels::adl::EpistemicObject"))
                {
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::beliefmodels::adl::EpistemicObject", __ctx))
                {
                    EpistemicObjectPrxHelper __h = new EpistemicObjectPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::beliefmodels::adl::EpistemicObject"))
                {
                    EpistemicObjectPrxHelper __h = new EpistemicObjectPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::beliefmodels::adl::EpistemicObject", __ctx))
                {
                    EpistemicObjectPrxHelper __h = new EpistemicObjectPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
