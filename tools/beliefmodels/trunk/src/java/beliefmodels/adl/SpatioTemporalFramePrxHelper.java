...
public final class SpatioTemporalFramePrxHelper extends Ice.ObjectPrxHelperBase implements SpatioTemporalFramePrx
{
    ...
    checkedCast(Ice.ObjectPrx __obj)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::beliefmodels::adl::SpatioTemporalFrame"))
                {
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::beliefmodels::adl::SpatioTemporalFrame", __ctx))
                {
                    SpatioTemporalFramePrxHelper __h = new SpatioTemporalFramePrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::beliefmodels::adl::SpatioTemporalFrame"))
                {
                    SpatioTemporalFramePrxHelper __h = new SpatioTemporalFramePrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::beliefmodels::adl::SpatioTemporalFrame", __ctx))
                {
                    SpatioTemporalFramePrxHelper __h = new SpatioTemporalFramePrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
