...
////////////////////////////////////////////////////////////////////////////////
CzEllMethodDualEllipse::CzEllMethodDualEllipse()
{
...
bool CzEllMethodDualEllipse::DualEllipse(double dDualEllipseMinGradient,
                                         ...
                                         CzEllipse *pEllipse)
{
	...
	for(unsigned i=0; i<pEllPoints.Size();i++) {
		if(pEllPoints[i].p.x < minx) minx=pEllPoints[i].p.x;
		if(pEllPoints[i].p.y < miny) miny=pEllPoints[i].p.y;
		if(pEllPoints[i].p.x > maxx) maxx=pEllPoints[i].p.x;
		if(pEllPoints[i].p.y > maxy) maxy=pEllPoints[i].p.y;
			
		float grad = (float)(sqrt(Sqr((float)GetPx16SC1(pSobelDx, (short)pEllPoints[i].p.x,(short)pEllPoints[i].p.y)) + Sqr((float)GetPx16SC1(pSobelDy, (short)pEllPoints[i].p.x,(short)pEllPoints[i].p.y))));
