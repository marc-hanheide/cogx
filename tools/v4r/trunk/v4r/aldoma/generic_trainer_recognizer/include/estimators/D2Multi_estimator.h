...
#ifndef D2MULTI_ESTIMATOR_H_
#define D2MULTI_ESTIMATOR_H_

#include <estimators/roll_hist_estimator.h>

template<typename PointInT, typename PointOutT, typename FeatureT>
  class D2MultiScaleEstimator : public RollEstimator<PointInT, PointOutT, FeatureT>
  {
  ...
  public:
    ...
    D2MultiScaleEstimator (bool apply_voxel_grid, bool apply_radius_removal, double leaf_size, int nr_bins)
    {
