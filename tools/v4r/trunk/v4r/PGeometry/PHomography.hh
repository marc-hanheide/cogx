 ...
 */
template<typename TN1, typename TN2, typename TN3>
inline void PHom::MapPoint(TN1 in[2], TN2 H[9], TN3 out[2])
{
 ...
 */
template<typename TN1, typename TN2, typename TN3>
bool PHom::ComputeAff(TN1 a1[2], TN1 a2[2], TN1 a3[2], 
                             TN2 b1[2], TN2 b2[2], TN2 b3[2], 
                             TN3 H[9])
{
    TN3 S;
 ...
 */
template<typename TN1, typename TN2, typename TN3>
bool PHom::ComputeHom(TN1 a1[2], TN1 a2[2], TN1 a3[2], TN1 a4[2],
                      TN2 b1[2], TN2 b2[2], TN2 b3[2], TN2 b4[2],
                      TN3 H[9])
{
  TN3 T1[9], invT[9];
