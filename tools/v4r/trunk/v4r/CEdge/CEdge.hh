...
public:
  ...
  void LinkEdge(IplImage *src, P::Array<Segment *> &segments, IplImage *dx=0, IplImage *dy=0);

  void EdgelHist(IplImage *canny, IplImage *indx, IplImage *indy);
