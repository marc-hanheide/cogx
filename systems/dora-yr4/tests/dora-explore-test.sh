...
TEST_CFG="--inject-after-goal \\\"<castutils.castextensions.WMInjection><op>ADD</op><adr><id></id><subarchitecture>dialogue</subarchitecture></adr><content class=\\\"de.dfki.lt.tr.dialogue.production.PlanVerbalizationRequest\\\"><taskID>1</taskID></content></castutils.castextensions.WMInjection>\\\" --wait 60 --wmcheck-allplacesexplored \\\"sa=spatial.sa;xpath=//status[node()='TRUEPLACE'];type=SpatialData.Place;qualifier=ALL\\\""
################################################################################
