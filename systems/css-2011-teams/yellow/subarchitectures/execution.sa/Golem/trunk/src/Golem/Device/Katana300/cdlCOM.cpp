...
CCdlCOM::CCdlCOM(TCdlCOMDesc ccd) : _deviceName(""), _ccd(), _prtHdl(INVALID_HANDLE_VALUE), _oto() {
	...
	//std::cout << "CCdlCOM::CCdlCOM: Welcome to KNI v3.9.2" << std::endl; // TEST
	...
	nto.ReadTotalTimeoutConstant	= 0;//ccd.rttc;	// UPDATE
	nto.WriteTotalTimeoutMultiplier	= 0;
	nto.WriteTotalTimeoutConstant	= 0;//ccd.wttc;	// UPDATE
