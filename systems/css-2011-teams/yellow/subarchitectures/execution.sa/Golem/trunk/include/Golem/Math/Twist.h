...
public:
	...
	*/
	inline Twist(Real& theta, const class Mat34 &m) {
		golem::Mat34ToTwist(*this, theta, m);
	}
	...
	*/
	inline void toMat34(class Mat34& m, Real theta) const {
		golem::TwistToMat34(m, *this, theta);
	}
	...
	*/
	inline Real getPitch() const {
		return w.isZero() ? numeric_const<Real>::INF : w.dot(v) / w.magnitudeSquared();
	}
