...
#include <Golem/Device/Katana300/cdlCOMExceptions.h>

#define NUMBER_OF_RETRIES_SEND	3 // HACK, old value: 3  // Number of retries after a failing in the Communication
#define NUMBER_OF_RETRIES_RECV	3 // HACK, old value: 3  // Number of retries after a failing in the Communication
/******************************************************************************************************************/
