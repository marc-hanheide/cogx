...
#pragma once
#ifndef _GOLEM_DEVICE_KATANA_KATANA_H_
#define _GOLEM_DEVICE_KATANA_KATANA_H_
...
class GOLEM_LIBRARY_DECLDIR KatanaJoint {
public:
...
#endif /*_GOLEM_DEVICE_KATANA_KATANA_H_*/
