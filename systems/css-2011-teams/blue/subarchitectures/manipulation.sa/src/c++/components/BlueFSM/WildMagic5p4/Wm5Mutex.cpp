...
// old behavior
#define NUKLEI_WMF_USE_CRITICAL_SECTIONS

//----------------------------------------------------------------------------
#ifdef NUKLEI_WMF_USING_VC80
// See the comments at
...
Mutex::Mutex ()
{
#ifdef NUKLEI_WMF_USE_CRITICAL_SECTIONS
