classdef CodebookAlgorithm < handle & Utils
    ...
    properties
        ...
        %-----------------------------
        % Training phases struct for different updaters...
        UpdaterPhases = [];
        iUpdaterPhase = [];
        ...
        function set(obj, Mod, varargin)
            ...
            switch obj.UpdaterPhases{1}.type
                case {'olvq1', 'olvq', 'orlvq1', 'orlvq', 'laorlvq',...
                      'heurolvq', 'heurorlvq', 'heurforlvq', 'heurfolrlvq',...
        ...
        function Mod = run(obj, Mod, Data, varargin)
            ...
            if ~isfield(Data, 'NormedFeatureVectors')
                ...
                SOMData = som_data_struct(Data.FeatureVectors',...
                                          ...
                                          'label_names', Data.CategoryNames);
                % Normalize...
                SOMData = som_normalize(SOMData, obj.Norm);
            ...
            for iData = 1:size(SOMData,1)
                ...
                hHebb = (Mod.Ud(:,Mod.BMUs(1)) <= Mod.r);
                HebbDists = Mod.Distances .* hHebb;
                HebbDists(HebbDists == 0) = NaN;
                Mod.Activations = 1 - (HebbDists - min(HebbDists)) / (max(HebbDists) - min(HebbDists));
                Mod.Activations(isnan(Mod.Activations)) = 0;
