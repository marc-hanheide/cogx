 ...
 * @version $Revision: 1.51 $, $Date: 2005/10/13 20:33:48 $
 */
public class TextCCG {
    ...
    public static void main(String[] args) throws IOException, LexException { 
        ...
        while (true) {
			...
			if (input.equals(":show settings") || input.equals(":sh")) {
                ...
                prefs.putBoolean(AbstractCat.SHOW_FEATURES, true);
                prefs.putBoolean(AbstractCat.SHOW_SEMANTICS, true);
                prefs.put(AbstractCat.FEATURES_TO_SHOW, "");
                ...
                prefs.putBoolean(AbstractCat.SHOW_FEATURES, false);
                prefs.putBoolean(AbstractCat.SHOW_SEMANTICS, false);
                prefs.put(AbstractCat.FEATURES_TO_SHOW, "");
                ...
                prefs.put(AbstractCat.FEATURES_TO_SHOW, s);
                ...
                try {
                    ...
                    boolean showsem = prefs.getBoolean(AbstractCat.SHOW_SEMANTICS, true);
    ...
    public static void showSettings(Preferences prefs) {
        ...
        System.out.println();
        boolean showfeats = prefs.getBoolean(AbstractCat.SHOW_FEATURES, false);
        boolean showsem = prefs.getBoolean(AbstractCat.SHOW_SEMANTICS, true);
        String feats = prefs.get(AbstractCat.FEATURES_TO_SHOW, "");
