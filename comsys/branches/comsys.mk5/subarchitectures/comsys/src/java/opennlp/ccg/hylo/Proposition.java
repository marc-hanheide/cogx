...
public class Proposition extends HyloAtom {
	...
	/**
	 * Retrieve the word position of the word related to the proposition
	 * @return
	 */
	...
	/**
	 * Retrieve the utterance increment
	 */
	public int getUtteranceIncrement() {
		return utteranceIncrement;
	}
    ...
    public LF copy() {
        Proposition prop = new Proposition(_name, type);
    ...
    public Object unify(Object u, Substitution sub) throws UnifyFailure {
        ...
        if (u instanceof Proposition) {
            ...
            Proposition p = new Proposition(st.getName(), st);
            p.setWordPosition(stringPos);
            p.setUtteranceIncrement(utteranceIncrement);
            return p;
        }
