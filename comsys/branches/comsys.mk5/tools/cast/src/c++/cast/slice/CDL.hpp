...
#ifndef ___Users_plison_svn_cogx_comsys_mk5_tools_cast_src_c___cast_slice_CDL_hpp__
#define ___Users_plison_svn_cogx_comsys_mk5_tools_cast_src_c___cast_slice_CDL_hpp__
...
class WordServer;
bool operator==(const WordServer&, const WordServer&);
bool operator<(const WordServer&, const WordServer&);

class WordServerAsComponent;
bool operator==(const WordServerAsComponent&, const WordServerAsComponent&);
bool operator<(const WordServerAsComponent&, const WordServerAsComponent&);
...
::Ice::Object* upCast(::cast::examples::autogen::WordServer*);
::IceProxy::Ice::Object* upCast(::IceProxy::cast::examples::autogen::WordServer*);

::Ice::Object* upCast(::cast::examples::autogen::WordServerAsComponent*);
::IceProxy::Ice::Object* upCast(::IceProxy::cast::examples::autogen::WordServerAsComponent*);
...
void ice_writeTestStructStringPrx(const ::Ice::OutputStreamPtr&, const TestStructStringPrx&);
void ice_readTestStructStringPrx(const ::Ice::InputStreamPtr&, TestStructStringPrx&);
void ice_writeTestStructString(const ::Ice::OutputStreamPtr&, const TestStructStringPtr&);
void ice_readTestStructString(const ::Ice::InputStreamPtr&, TestStructStringPtr&);
...
void ice_writeTestStructIntPrx(const ::Ice::OutputStreamPtr&, const TestStructIntPrx&);
void ice_readTestStructIntPrx(const ::Ice::InputStreamPtr&, TestStructIntPrx&);
void ice_writeTestStructInt(const ::Ice::OutputStreamPtr&, const TestStructIntPtr&);
void ice_readTestStructInt(const ::Ice::InputStreamPtr&, TestStructIntPtr&);
...
void ice_writeWorkingMemoryEntryPrx(const ::Ice::OutputStreamPtr&, const WorkingMemoryEntryPrx&);
void ice_readWorkingMemoryEntryPrx(const ::Ice::InputStreamPtr&, WorkingMemoryEntryPrx&);
void ice_writeWorkingMemoryEntry(const ::Ice::OutputStreamPtr&, const WorkingMemoryEntryPtr&);
void ice_readWorkingMemoryEntry(const ::Ice::InputStreamPtr&, WorkingMemoryEntryPtr&);
...
void ice_writeCASTTestStructPrx(const ::Ice::OutputStreamPtr&, const CASTTestStructPrx&);
void ice_readCASTTestStructPrx(const ::Ice::InputStreamPtr&, CASTTestStructPrx&);
void ice_writeCASTTestStruct(const ::Ice::OutputStreamPtr&, const CASTTestStructPtr&);
void ice_readCASTTestStruct(const ::Ice::InputStreamPtr&, CASTTestStructPtr&);
...
void ice_writeTestDummyStructPrx(const ::Ice::OutputStreamPtr&, const TestDummyStructPrx&);
void ice_readTestDummyStructPrx(const ::Ice::InputStreamPtr&, TestDummyStructPrx&);
void ice_writeTestDummyStruct(const ::Ice::OutputStreamPtr&, const TestDummyStructPtr&);
void ice_readTestDummyStruct(const ::Ice::InputStreamPtr&, TestDummyStructPtr&);
...
void ice_writeWorkingMemoryPrx(const ::Ice::OutputStreamPtr&, const WorkingMemoryPrx&);
void ice_readWorkingMemoryPrx(const ::Ice::InputStreamPtr&, WorkingMemoryPrx&);
void ice_writeWorkingMemory(const ::Ice::OutputStreamPtr&, const WorkingMemoryPtr&);
void ice_readWorkingMemory(const ::Ice::InputStreamPtr&, WorkingMemoryPtr&);
...
void ice_writeTaskManagerPrx(const ::Ice::OutputStreamPtr&, const TaskManagerPrx&);
void ice_readTaskManagerPrx(const ::Ice::InputStreamPtr&, TaskManagerPrx&);
void ice_writeTaskManager(const ::Ice::OutputStreamPtr&, const TaskManagerPtr&);
void ice_readTaskManager(const ::Ice::InputStreamPtr&, TaskManagerPtr&);
...
void ice_writeComponentManagerPrx(const ::Ice::OutputStreamPtr&, const ComponentManagerPrx&);
void ice_readComponentManagerPrx(const ::Ice::InputStreamPtr&, ComponentManagerPrx&);
void ice_writeComponentManager(const ::Ice::OutputStreamPtr&, const ComponentManagerPtr&);
void ice_readComponentManager(const ::Ice::InputStreamPtr&, ComponentManagerPtr&);
...
void ice_writeTimeServerPrx(const ::Ice::OutputStreamPtr&, const TimeServerPrx&);
void ice_readTimeServerPrx(const ::Ice::InputStreamPtr&, TimeServerPrx&);
void ice_writeTimeServer(const ::Ice::OutputStreamPtr&, const TimeServerPtr&);
void ice_readTimeServer(const ::Ice::InputStreamPtr&, TimeServerPtr&);
...
void ice_writeCASTComponentPrx(const ::Ice::OutputStreamPtr&, const CASTComponentPrx&);
void ice_readCASTComponentPrx(const ::Ice::InputStreamPtr&, CASTComponentPrx&);
void ice_writeCASTComponent(const ::Ice::OutputStreamPtr&, const CASTComponentPtr&);
void ice_readCASTComponent(const ::Ice::InputStreamPtr&, CASTComponentPtr&);
...
void ice_writeWorkingMemoryAttachedComponentPrx(const ::Ice::OutputStreamPtr&, const WorkingMemoryAttachedComponentPrx&);
void ice_readWorkingMemoryAttachedComponentPrx(const ::Ice::InputStreamPtr&, WorkingMemoryAttachedComponentPrx&);
void ice_writeWorkingMemoryAttachedComponent(const ::Ice::OutputStreamPtr&, const WorkingMemoryAttachedComponentPtr&);
void ice_readWorkingMemoryAttachedComponent(const ::Ice::InputStreamPtr&, WorkingMemoryAttachedComponentPtr&);
...
void ice_writeWorkingMemoryReaderComponentPrx(const ::Ice::OutputStreamPtr&, const WorkingMemoryReaderComponentPrx&);
void ice_readWorkingMemoryReaderComponentPrx(const ::Ice::InputStreamPtr&, WorkingMemoryReaderComponentPrx&);
void ice_writeWorkingMemoryReaderComponent(const ::Ice::OutputStreamPtr&, const WorkingMemoryReaderComponentPtr&);
void ice_readWorkingMemoryReaderComponent(const ::Ice::InputStreamPtr&, WorkingMemoryReaderComponentPtr&);
...
void ice_writeManagedComponentPrx(const ::Ice::OutputStreamPtr&, const ManagedComponentPrx&);
void ice_readManagedComponentPrx(const ::Ice::InputStreamPtr&, ManagedComponentPrx&);
void ice_writeManagedComponent(const ::Ice::OutputStreamPtr&, const ManagedComponentPtr&);
void ice_readManagedComponent(const ::Ice::InputStreamPtr&, ManagedComponentPtr&);
...
void ice_writeUnmanagedComponentPrx(const ::Ice::OutputStreamPtr&, const UnmanagedComponentPrx&);
void ice_readUnmanagedComponentPrx(const ::Ice::InputStreamPtr&, UnmanagedComponentPrx&);
void ice_writeUnmanagedComponent(const ::Ice::OutputStreamPtr&, const UnmanagedComponentPtr&);
void ice_readUnmanagedComponent(const ::Ice::InputStreamPtr&, UnmanagedComponentPtr&);
...
void ice_writeComponentFactoryPrx(const ::Ice::OutputStreamPtr&, const ComponentFactoryPrx&);
void ice_readComponentFactoryPrx(const ::Ice::InputStreamPtr&, ComponentFactoryPrx&);
void ice_writeComponentFactory(const ::Ice::OutputStreamPtr&, const ComponentFactoryPtr&);
void ice_readComponentFactory(const ::Ice::InputStreamPtr&, ComponentFactoryPtr&);
...
typedef ::IceInternal::Handle< ::cast::examples::autogen::WordServer> WordServerPtr;
typedef ::IceInternal::ProxyHandle< ::IceProxy::cast::examples::autogen::WordServer> WordServerPrx;

void __read(::IceInternal::BasicStream*, WordServerPrx&);
void __patch__WordServerPtr(void*, ::Ice::ObjectPtr&);

void ice_writeWordServerPrx(const ::Ice::OutputStreamPtr&, const WordServerPrx&);
void ice_readWordServerPrx(const ::Ice::InputStreamPtr&, WordServerPrx&);
void ice_writeWordServer(const ::Ice::OutputStreamPtr&, const WordServerPtr&);
void ice_readWordServer(const ::Ice::InputStreamPtr&, WordServerPtr&);

typedef ::IceInternal::Handle< ::cast::examples::autogen::WordServerAsComponent> WordServerAsComponentPtr;
typedef ::IceInternal::ProxyHandle< ::IceProxy::cast::examples::autogen::WordServerAsComponent> WordServerAsComponentPrx;

void __read(::IceInternal::BasicStream*, WordServerAsComponentPrx&);
void __patch__WordServerAsComponentPtr(void*, ::Ice::ObjectPtr&);

void ice_writeWordServerAsComponentPrx(const ::Ice::OutputStreamPtr&, const WordServerAsComponentPrx&);
void ice_readWordServerAsComponentPrx(const ::Ice::InputStreamPtr&, WordServerAsComponentPrx&);
void ice_writeWordServerAsComponent(const ::Ice::OutputStreamPtr&, const WordServerAsComponentPtr&);
void ice_readWordServerAsComponent(const ::Ice::InputStreamPtr&, WordServerAsComponentPtr&);
...
const ::std::string CASTRELEASESTRING = "2.0.2 (Shady Lane)";
...
void ice_writeStringMap(const ::Ice::OutputStreamPtr&, const StringMap&);
void ice_readStringMap(const ::Ice::InputStreamPtr&, StringMap&);
...
void ice_writeComponentLanguage(const ::Ice::OutputStreamPtr&, ComponentLanguage);
void ice_readComponentLanguage(const ::Ice::InputStreamPtr&, ComponentLanguage&);
...
void ice_writeComponentDescription(const ::Ice::OutputStreamPtr&, const ComponentDescription&);
void ice_readComponentDescription(const ::Ice::InputStreamPtr&, ComponentDescription&);
...
void ice_writeWorkingMemoryAddress(const ::Ice::OutputStreamPtr&, const WorkingMemoryAddress&);
void ice_readWorkingMemoryAddress(const ::Ice::InputStreamPtr&, WorkingMemoryAddress&);
...
void ice_writeWorkingMemoryEntrySeq(const ::Ice::OutputStreamPtr&, const WorkingMemoryEntrySeq&);
void ice_readWorkingMemoryEntrySeq(const ::Ice::InputStreamPtr&, WorkingMemoryEntrySeq&);
...
void ice_writeWorkingMemoryOperation(const ::Ice::OutputStreamPtr&, WorkingMemoryOperation);
void ice_readWorkingMemoryOperation(const ::Ice::InputStreamPtr&, WorkingMemoryOperation&);
...
void ice_writeWorkingMemoryChangeQueueBehaviour(const ::Ice::OutputStreamPtr&, WorkingMemoryChangeQueueBehaviour);
void ice_readWorkingMemoryChangeQueueBehaviour(const ::Ice::InputStreamPtr&, WorkingMemoryChangeQueueBehaviour&);
...
void ice_writeWorkingMemoryPermissions(const ::Ice::OutputStreamPtr&, WorkingMemoryPermissions);
void ice_readWorkingMemoryPermissions(const ::Ice::InputStreamPtr&, WorkingMemoryPermissions&);
...
void ice_writeWorkingMemoryLockRequest(const ::Ice::OutputStreamPtr&, WorkingMemoryLockRequest);
void ice_readWorkingMemoryLockRequest(const ::Ice::InputStreamPtr&, WorkingMemoryLockRequest&);
...
void ice_writeFilterRestriction(const ::Ice::OutputStreamPtr&, FilterRestriction);
void ice_readFilterRestriction(const ::Ice::InputStreamPtr&, FilterRestriction&);
...
void ice_writeReceiverDeleteCondition(const ::Ice::OutputStreamPtr&, ReceiverDeleteCondition);
void ice_readReceiverDeleteCondition(const ::Ice::InputStreamPtr&, ReceiverDeleteCondition&);
...
void ice_writeWorkingMemoryChange(const ::Ice::OutputStreamPtr&, const WorkingMemoryChange&);
void ice_readWorkingMemoryChange(const ::Ice::InputStreamPtr&, WorkingMemoryChange&);
...
void ice_writeWorkingMemoryChangeFilter(const ::Ice::OutputStreamPtr&, const WorkingMemoryChangeFilter&);
void ice_readWorkingMemoryChangeFilter(const ::Ice::InputStreamPtr&, WorkingMemoryChangeFilter&);
...
void ice_writeCASTTime(const ::Ice::OutputStreamPtr&, const CASTTime&);
void ice_readCASTTime(const ::Ice::InputStreamPtr&, CASTTime&);
...
void ice_writeTaskOutcome(const ::Ice::OutputStreamPtr&, TaskOutcome);
void ice_readTaskOutcome(const ::Ice::InputStreamPtr&, TaskOutcome&);
...
void ice_writeTaskManagementDecision(const ::Ice::OutputStreamPtr&, TaskManagementDecision);
void ice_readTaskManagementDecision(const ::Ice::InputStreamPtr&, TaskManagementDecision&);
...
public:
    ...
    void addComponentDescription(const ::cast::cdl::ComponentDescription& description)
    {
        addComponentDescription(description, 0);
    }
    void addComponentDescription(const ::cast::cdl::ComponentDescription& description, const ::Ice::Context& __ctx)
    {
        addComponentDescription(description, &__ctx);
    }
    
private:

    void addComponentDescription(const ::cast::cdl::ComponentDescription&, const ::Ice::Context*);
    
public:

    ::cast::cdl::ComponentDescription getComponentDescription(const ::std::string& componentID)
    {
        return getComponentDescription(componentID, 0);
    }
    ::cast::cdl::ComponentDescription getComponentDescription(const ::std::string& componentID, const ::Ice::Context& __ctx)
    {
        return getComponentDescription(componentID, &__ctx);
    }
    
private:

    ::cast::cdl::ComponentDescription getComponentDescription(const ::std::string&, const ::Ice::Context*);
...
class WordServer : virtual public ::IceProxy::Ice::Object
{
public:
    ...
    ::std::string getNewWord(const ::Ice::Context& __ctx)
    {
        return getNewWord(&__ctx);
    }
    
private:

    ::std::string getNewWord(const ::Ice::Context*);
    
public:
    
    ::IceInternal::ProxyHandle<WordServer> ice_context(const ::Ice::Context& __context) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_context(__context).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_context(__context).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_adapterId(const std::string& __id) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_adapterId(__id).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_adapterId(__id).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_endpoints(const ::Ice::EndpointSeq& __endpoints) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_endpoints(__endpoints).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_endpoints(__endpoints).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_locatorCacheTimeout(int __timeout) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_locatorCacheTimeout(__timeout).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_locatorCacheTimeout(__timeout).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_connectionCached(bool __cached) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_connectionCached(__cached).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_connectionCached(__cached).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_endpointSelection(::Ice::EndpointSelectionType __est) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_endpointSelection(__est).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_endpointSelection(__est).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_secure(bool __secure) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_secure(__secure).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_secure(__secure).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_preferSecure(bool __preferSecure) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_preferSecure(__preferSecure).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_preferSecure(__preferSecure).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_router(const ::Ice::RouterPrx& __router) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_router(__router).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_router(__router).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_locator(const ::Ice::LocatorPrx& __locator) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_locator(__locator).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_locator(__locator).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_collocationOptimized(bool __co) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_collocationOptimized(__co).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_collocationOptimized(__co).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_twoway() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_twoway().get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_twoway().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_oneway() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_oneway().get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_oneway().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_batchOneway() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_batchOneway().get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_batchOneway().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_datagram() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_datagram().get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_datagram().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_batchDatagram() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_batchDatagram().get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_batchDatagram().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_compress(bool __compress) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_compress(__compress).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_compress(__compress).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_timeout(int __timeout) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_timeout(__timeout).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_timeout(__timeout).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServer> ice_connectionId(const std::string& __id) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServer*>(_Base::ice_connectionId(__id).get());
    #else
        return dynamic_cast<WordServer*>(::IceProxy::Ice::Object::ice_connectionId(__id).get());
    #endif
    }
...
class WordServerAsComponent : virtual public ::IceProxy::cast::interfaces::CASTComponent
{
public:
...
public:
    ...
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_context(const ::Ice::Context& __context) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_context(__context).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_context(__context).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_adapterId(const std::string& __id) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_adapterId(__id).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_adapterId(__id).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_endpoints(const ::Ice::EndpointSeq& __endpoints) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_endpoints(__endpoints).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_endpoints(__endpoints).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_locatorCacheTimeout(int __timeout) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_locatorCacheTimeout(__timeout).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_locatorCacheTimeout(__timeout).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_connectionCached(bool __cached) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_connectionCached(__cached).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_connectionCached(__cached).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_endpointSelection(::Ice::EndpointSelectionType __est) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_endpointSelection(__est).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_endpointSelection(__est).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_secure(bool __secure) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_secure(__secure).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_secure(__secure).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_preferSecure(bool __preferSecure) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_preferSecure(__preferSecure).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_preferSecure(__preferSecure).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_router(const ::Ice::RouterPrx& __router) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_router(__router).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_router(__router).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_locator(const ::Ice::LocatorPrx& __locator) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_locator(__locator).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_locator(__locator).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_collocationOptimized(bool __co) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_collocationOptimized(__co).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_collocationOptimized(__co).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_twoway() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_twoway().get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_twoway().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_oneway() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_oneway().get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_oneway().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_batchOneway() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_batchOneway().get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_batchOneway().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_datagram() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_datagram().get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_datagram().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_batchDatagram() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_batchDatagram().get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_batchDatagram().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_compress(bool __compress) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_compress(__compress).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_compress(__compress).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_timeout(int __timeout) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_timeout(__timeout).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_timeout(__timeout).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<WordServerAsComponent> ice_connectionId(const std::string& __id) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<WordServerAsComponent*>(_Base::ice_connectionId(__id).get());
    #else
        return dynamic_cast<WordServerAsComponent*>(::IceProxy::Ice::Object::ice_connectionId(__id).get());
    #endif
    }
...
public:
    ...
    virtual void addComponentDescription(const ::cast::cdl::ComponentDescription&, const ::Ice::Context*) = 0;

    virtual ::cast::cdl::ComponentDescription getComponentDescription(const ::std::string&, const ::Ice::Context*) = 0;
};
...
class WordServer : virtual public ::IceDelegate::Ice::Object
{
public:

    virtual ::std::string getNewWord(const ::Ice::Context*) = 0;
};

class WordServerAsComponent : virtual public ::IceDelegate::cast::interfaces::CASTComponent
{
public:
...
public:
    ...
    virtual void addComponentDescription(const ::cast::cdl::ComponentDescription&, const ::Ice::Context*);

    virtual ::cast::cdl::ComponentDescription getComponentDescription(const ::std::string&, const ::Ice::Context*);
};
...
class WordServer : virtual public ::IceDelegate::cast::examples::autogen::WordServer,
                   virtual public ::IceDelegateM::Ice::Object
{
public:

    virtual ::std::string getNewWord(const ::Ice::Context*);
};

class WordServerAsComponent : virtual public ::IceDelegate::cast::examples::autogen::WordServerAsComponent,
                              virtual public ::IceDelegateM::cast::interfaces::CASTComponent
{
public:
...
static TestStructString__staticInit _TestStructString_init;
...
public:
    ...
    virtual void addComponentDescription(const ::cast::cdl::ComponentDescription&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___addComponentDescription(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual ::cast::cdl::ComponentDescription getComponentDescription(const ::std::string&, const ::Ice::Current& = ::Ice::Current()) const = 0;
    ::Ice::DispatchStatus ___getComponentDescription(::IceInternal::Incoming&, const ::Ice::Current&) const;
...
class WordServer : virtual public ::Ice::Object
{
public:

    typedef WordServerPrx ProxyType;
    typedef WordServerPtr PointerType;
    ...
    virtual ::std::string getNewWord(const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___getNewWord(::IceInternal::Incoming&, const ::Ice::Current&);
...
class WordServerAsComponent : virtual public ::cast::interfaces::CASTComponent
{
public:

    typedef WordServerAsComponentPrx ProxyType;
    typedef WordServerAsComponentPtr PointerType;
