...
public final class _WordServerAsComponentDelM extends Ice._ObjectDelM implements _WordServerAsComponentDel
{
    public String
    getNewWord(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getNewWord", Ice.OperationMode.Normal, __ctx);
        try
        {
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            {
                IceInternal.BasicStream __os = __og.os();
                cast.interfaces.ComponentManagerPrxHelper.__write(__os, man);
            }
            catch(Ice.LocalException __ex)
            {
                __og.abort(__ex);
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            {
                IceInternal.BasicStream __os = __og.os();
                cast.interfaces.TimeServerPrxHelper.__write(__os, ts);
            }
            catch(Ice.LocalException __ex)
            {
                __og.abort(__ex);
