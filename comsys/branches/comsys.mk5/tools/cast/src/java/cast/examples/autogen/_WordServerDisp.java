...
public abstract class _WordServerDisp extends Ice.ObjectImpl implements WordServer
{
    protected void
    ...
    ___getNewWord(WordServer __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
