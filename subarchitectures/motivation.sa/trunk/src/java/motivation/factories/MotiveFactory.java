...
public class MotiveFactory {
	public static Motive createMotive(WorkingMemoryAddress src) {
		...
		return new Motive(created, created, src, null, null, MotiveStatus.UNSURFACED, 0, MotivePriority.UNSURFACE, 0, 0, 0, "",0.0,10,60);
	}
	...
	public static CategorizePlaceMotive createCategorizePlaceMotive(WorkingMemoryAddress src) {
		CASTTime created = CASTUtils.getTimeServer().getCASTTime();
		return new CategorizePlaceMotive(created, created, src, null, null, MotiveStatus.UNSURFACED, 0, MotivePriority.UNSURFACE, 0, 0, 0, "",0.0,5,180,0);
	}
	public static TestMotive createTestMotive(WorkingMemoryAddress src) {
		CASTTime created = CASTUtils.getTimeServer().getCASTTime();
		return new TestMotive(created, created, src, null, null, MotiveStatus.UNSURFACED, 0, MotivePriority.UNSURFACE, 0, 0, 0, "",0.0,10,60,"hurgs");
	}
	...
	public static GeneralGoalMotive createGeneralGoalMotive(WorkingMemoryAddress src) {
		CASTTime created = CASTUtils.getTimeServer().getCASTTime();
		return new GeneralGoalMotive(created, created, src, null, null, MotiveStatus.UNSURFACED, 0, MotivePriority.UNSURFACE, 0, 0, 0,  "",0.0,10,Integer.MAX_VALUE,"");
	}
}
