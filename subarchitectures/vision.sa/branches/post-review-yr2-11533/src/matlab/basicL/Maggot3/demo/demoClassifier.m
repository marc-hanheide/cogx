...
min_samps_per_model_feat_sel = 2*dim ;          % (int) minimum number of samples per model observed before applying feature selection
min_th_feat_sel =  0.05 ;                       % (double) threshold on importance below which a feature is removed
