...
% W = 1 ;
    ...
    for i = 1 : length(negModel.pdfs)
        ...
        %p_tmp = p1_z_c1{i} ./ (p1_z{i} + minTol) ;
        %p1_c1_g_z = horzcat(p1_c1_g_z, p_tmp) ; 
        
%         mean((1-p1_c0_g_z{i})-p1_c1_g_z{i}) 
    end
...
%     p1_c1_g_z = p1_z_c1 ./ (p1_z + minTol) ;
    ...
    %precalcs.p1_c1_g_z = p1_c1_g_z ; % negative models evaluated posterior
...
% % %    % generate sigma points 
% % %     MaxV = 3 ;
% % %     f0 = mergeDistributions( posModel, negModel, [modelPriors.pPos , modelPriors.pNeg]  ) ;
% % % %     f0 = posModel ;
% % %     
% % %     % calculate sigma points for entire set
% % %     [X, sigPointsPerComponent, w, k ] = getAllSigmaPointsOnMixture( f0, MaxV ) ;
