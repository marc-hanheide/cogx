...
public:
	...
	static int DownSamplePixelData(int gl_format, int width, int height, 
		int ds, const unsigned char * pin, unsigned char * pout);
	static int DownSamplePixelData(int gl_format, int width, int height, 
...
public:
	int SetImageData(int width, int height, const unsigned char * data, unsigned int gl_format , int& ds );
	int SetImageData(int width, int height, const float * data, unsigned int gl_format , int& ds );
...
public:
	...
	int	IsTexOdd(){return (_imgWidth&0x01) && (_imgHeight & 0x01); }
