...
public:
  ...
  inline bool Have3D(){return (pos.nbElts()==3?true:false);}
...
inline void KeypointDescriptor::AdaptPos(Vector &p)
{
  //mean
  pos = (cnt_pos*pos + p)/(cnt_pos+1);
  //..or sliding mean...
  //pos = (pos + p)/2;
  cnt_pos++;
}
