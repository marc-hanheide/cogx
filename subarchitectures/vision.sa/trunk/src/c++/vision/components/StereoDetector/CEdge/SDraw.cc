...
void SDraw::WriteText(IplImage *img, const char* text, double x, double y, CvScalar c, int thickness)
{
  CvFont font;
  cvInitFont( &font, CV_FONT_HERSHEY_PLAIN, 1.1, 1.2, 0, thickness, CV_AA );
