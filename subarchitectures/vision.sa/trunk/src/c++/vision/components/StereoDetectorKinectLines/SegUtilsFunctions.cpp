...
{
  printf("[SegUtilsFunctions::CheckAnnotation] Change to new surface representation! Implement! NOW!\n");
  printf("[SegUtilsFunctions::CheckAnnotation] And cleanup this stuff!\n");
...
//         // at position j:
//         // annoLabel = annoLabels[i]
//         // at the real image: objects[j]
//     
...
// 
//       
//     /// TODO Backcheck: Diese pixel müssen jetzt genauso zusammengerechnet werden!!!
// // printf("Do the backcheck: Best graph-Cut group[%u]: ", best_graph_cut_group);
...
// 
// 
// //   overall_too_much_pixel += too_much_pixel;
// //   overall_res_backcheck_indices += nr_indices_annoLabel[i];
// 
//   
