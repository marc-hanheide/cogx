...
% % % % %%%%%%%%%%%%% start of previous simple k-means %%%%%%%%%%%%%%%%%% 
...
% % % %    
% % % % p1 = sum((pdf.Mu - repmat(pdf_split.Mu(:,1),1,length(pdf.w))).^2,1 ) ;
% % % % p2 = sum((pdf.Mu - repmat(pdf_split.Mu(:,2),1,length(pdf.w))).^2,1 ) ;
% % % % p_c = [p1 ; p2] ;
% % % % 
% % % % [dis, cls] = max(p_c) ;
% % % % 
...
% % % %         pdf_split.w = [pdf_split.w, w_out1] ;
% % % %         pdf_split.Mu = [pdf_split.Mu, new_mu1] ;
% % % %         pdf_split.Cov = horzcat(pdf_split.Cov, {new_Cov1}) ;
% % % %     end
% % % % end
% % % % %%%%%%%%%%%%% end of previous simple k-means %%%%%%%%%%%%%%%%%%
