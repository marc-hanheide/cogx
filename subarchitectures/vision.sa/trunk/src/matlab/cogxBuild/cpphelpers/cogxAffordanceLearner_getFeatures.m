function [features] = cogxAffordanceLearner_getFeatures(Image, Mask, pts3d)
   % Image - image - byte_array, 3D (x, y, RGB)
   % Mask - segmentation mask - byte_array (GS, value=1 for selected pixels)

   features = [];

   % Old names in VisualLearner: B - Mask, X - Image
%   global Figs
