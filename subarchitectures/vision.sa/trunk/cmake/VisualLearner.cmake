...
if (BUILD_SA_VISION_VISLEARNER)
   ...
   if (BUILD_SA_VISION_VISLEARNER_FAKE)
      ...
      if (BUILD_SA_VISION_VISLEARNER_CTF)
         ...
         #
         # NOTE: This will only build a project file and a script to run Matlab
         # with deploytool. You have to build the CTF manually before the Proxy
         # can be built.
         #
         ...
         IF (EXISTS ${VisualLearnerCtf_BINARY_DIR}/build/libVisualLearnerCtf.h)
            ...
            set(VISUALLEARNER_LIBRARY_DIRS ${VISUALLEARNER_LIBRARY_DIRS} ${VisualLearnerProxy_BINARY_DIR})
            install(FILES
               ${VisualLearnerCtf_BINARY_DIR}/build/libVisualLearnerCtf.h
               ${VisualLearnerCtf_BINARY_DIR}/build/libVisualLearnerCtf.so
               DESTINATION
               ${OUTPUT}/lib
               )
         ELSE()
