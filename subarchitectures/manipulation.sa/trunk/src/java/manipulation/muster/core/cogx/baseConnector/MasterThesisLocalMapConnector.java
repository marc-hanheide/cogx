 ...
 * 
 */
public class MasterThesisLocalMapConnector implements MapConnector {
	 ...
	 *            current manipulator
	 */
	public MasterThesisLocalMapConnector(Manipulator manipulator) {
		this.manipulator = manipulator;

		try {
			localMapInterface = ((MasterThesisRunner) manipulator.getRunner())
	...
	public void updateMap() throws ExternalMemoryException {
		try {
			...
			allPlaces = ((MasterThesisRunner) manipulator.getRunner())
