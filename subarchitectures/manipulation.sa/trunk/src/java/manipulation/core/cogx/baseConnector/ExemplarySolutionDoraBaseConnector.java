 ...
 * 
 */
public class ExemplarySolutionDoraBaseConnector implements BaseConnector {
	 ...
	 *            current manipulator
	 */
	public ExemplarySolutionDoraBaseConnector(Manipulator manipulator) {
	...
	public void goTo(BasePositionData target) throws ExternalMemoryException {
		...
		((ExemplarySolutionRunner) manipulator.getRunner()).addChangeFilter(
	...
	public void robotPositionChanged(WorkingMemoryChange _wmc) {
		try {
			RobotPose2d robotPose = ((ExemplarySolutionRunner) manipulator
