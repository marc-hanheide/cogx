/**
 * CategoricalShapeIntegrator class.
...
{
	return new CategoricalShapeIntegrator();
}
}
...
// ------------------------------------------------------
CategoricalShapeIntegrator::CategoricalShapeIntegrator(): _cfgGroup("ShapeIntegrator")
{
	_resultsQueue.clear();
...
// ------------------------------------------------------
CategoricalShapeIntegrator::~CategoricalShapeIntegrator()
{
...
// ------------------------------------------------------
void CategoricalShapeIntegrator::configure(const map<string,string> &config)
{
...
// ------------------------------------------------------
void CategoricalShapeIntegrator::start()
{
	// Add change filters
	addChangeFilter(createLocalTypeFilter<CategoricalData::LaserResults>(cdl::OVERWRITE),
			new MemberFunctionChangeReceiver<CategoricalShapeIntegrator>(this,
					&CategoricalShapeIntegrator::newLaserResults));

	addChangeFilter(createLocalTypeFilter<CategoricalData::Odometry>(cdl::OVERWRITE),
			new MemberFunctionChangeReceiver<CategoricalShapeIntegrator>(this,
					&CategoricalShapeIntegrator::newOdometry));

	addChangeFilter(
      createLocalTypeFilter<SpatialProperties::RoomShapePlaceProperty>(cdl::ADD),
      new MemberFunctionChangeReceiver<CategoricalShapeIntegrator>(
          this, &CategoricalShapeIntegrator::newShapePlaceProperty));
...
// ------------------------------------------------------
void CategoricalShapeIntegrator::stop()
{
	debug("Stop!");
}
...
// ------------------------------------------------------
void CategoricalShapeIntegrator::newOdometry(const cast::cdl::WorkingMemoryChange & change)
{
...
// ------------------------------------------------------
void CategoricalShapeIntegrator::newLaserResults(const cast::cdl::WorkingMemoryChange & change)
{
	pthread_mutex_lock(&_dataSignalMutex);
...
// ------------------------------------------------------
void CategoricalShapeIntegrator::newShapePlaceProperty(
    const cast::cdl::WorkingMemoryChange &change)
{
  // When a new shape property is added, it was either by us, or by the place
  ...
  typedef SpatialProperties::RoomShapePlacePropertyPtr prop_ptr_t;
...

  {
    ...
    it = _placeShapePropertyIds.find(prop->placeId);

    if (it == _placeShapePropertyIds.end())
    {
      _placeShapePropertyIds[prop->placeId] = change.address.id;
    }
    else
    {
...
// ------------------------------------------------------
bool CategoricalShapeIntegrator::readyToAccumulate()
{
...
// ------------------------------------------------------
void CategoricalShapeIntegrator::integrateWithPrior(CategoricalData::ClassifierOutputs &priorOutputs,
...
// ------------------------------------------------------
CategoricalData::ClassifierOutputs CategoricalShapeIntegrator::combineWithPrior(const CategoricalData::ClassifierOutputs &priorOutputs,
		unsigned int &priorOutputsCount, const CategoricalData::ClassifierOutputs &newOutputs,
		unsigned int newOutputsCount)
{
