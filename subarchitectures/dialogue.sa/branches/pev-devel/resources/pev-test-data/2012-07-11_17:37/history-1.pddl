...
(:init  (= (associated-with person0) dummy-room)
        ...
        (probabilistic  0.1775  (assign (category room_0__a1) corridor)
                        0.4889  (assign (category room_0__a1) meetingroom)
                        0.3336  (assign (category room_0__a1) office)
        )
        ...
        (probabilistic  0.7958  (assign (leads_to_room place_1__b corridor) true))
        (probabilistic  0.3046  (assign (leads_to_room place_2__b meetingroom) true))
        (probabilistic  0.7958  (assign (leads_to_room place_2__b corridor) true))
        ...
        (probabilistic  0.7958  (assign (leads_to_room place_3__b corridor) true))
...
(__commit-sample_object_location-0 robot_0__c visualobject2 magazine in room_0__a1), EXECUTED
...
(search_for_object_in_room robot_0__c magazine room_0__a1 place_0__b visualobject2), EXECUTABLE
(goal ), EXECUTABLE
END_PLAN
actions:
0: SUCCEEDED init 
...
3: SUCCEEDED __commit-sample_object_location-0 0:C@spatial.sa visualobject2 magazine in 0:A1@coma
...
9: PENDING search_for_object_in_room 0:C@spatial.sa magazine 0:A1@coma 0:B@spatial.sa visualobject2
10: PENDING goal 
links:
...
0 2 DEPENDS p-obj_exists magazine in 0:A1@coma meetingroom VALUE: 0.800000036577
...
3 9 DEPENDS related-to visualobject2 MODALITY: poss 0:A1@coma VALUE: true
...
(:init  (= (associated-with person0) dummy-room)
        ...
        (is-virtual visualobject3)
        (is-virtual visualobject4)
        (probabilistic  0.3074  (assign (leads_to_room place_1__b meetingroom) true))
        (probabilistic  0.3607  (assign (category room_0__a1) corridor)
                        0.2387  (assign (category room_0__a1) meetingroom)
                        0.4006  (assign (category room_0__a1) office)
        )
        (probabilistic  0.3465  (assign (leads_to_room place_4__b meetingroom) true))
        (probabilistic  0.3465  (assign (leads_to_room place_4__b office) true))
        (probabilistic  0.3074  (assign (leads_to_room place_1__b office) true))
        (probabilistic  0.3478  (assign (leads_to_room place_3__b office) true))
        (probabilistic  0.7908  (assign (leads_to_room place_1__b corridor) true))
        (probabilistic  0.3478  (assign (leads_to_room place_2__b meetingroom) true))
        (probabilistic  0.7165  (assign (leads_to_room place_2__b corridor) true))
        (probabilistic  0.3478  (assign (leads_to_room place_2__b office) true))
        (probabilistic  0.2000  (assign (contains-a-person-prior room_0__a1) true))
        (probabilistic  0.7165  (assign (leads_to_room place_3__b corridor) true))
        (probabilistic  0.7139  (assign (leads_to_room place_4__b corridor) true))
        (probabilistic  0.3478  (assign (leads_to_room place_3__b meetingroom) true))
)
...
(:init  (= (associated-with person0) dummy-room)
        ...
        (is-virtual visualobject3)
        (is-virtual visualobject4)
        (probabilistic  0.1043  (assign (leads_to_room place_5__b office) true))
        (probabilistic  0.3074  (assign (leads_to_room place_1__b meetingroom) true))
        (probabilistic  0.0465  (assign (category room_0__a1) corridor)
                        0.7243  (assign (category room_0__a1) meetingroom)
                        0.2292  (assign (category room_0__a1) office)
        )
        (probabilistic  0.2640  (assign (leads_to_room place_4__b meetingroom) true))
        (probabilistic  0.3421  (assign (leads_to_room place_5__b corridor) true))
        (probabilistic  0.8437  (assign (leads_to_room place_2__b corridor) true))
        (probabilistic  0.2640  (assign (leads_to_room place_4__b office) true))
        (probabilistic  0.3074  (assign (leads_to_room place_1__b office) true))
        (probabilistic  0.1043  (assign (leads_to_room place_5__b meetingroom) true))
        (probabilistic  0.2650  (assign (leads_to_room place_3__b office) true))
        (probabilistic  0.2648  (assign (leads_to_room place_6__b meetingroom) true))
        (probabilistic  0.7908  (assign (leads_to_room place_1__b corridor) true))
        (probabilistic  0.2788  (assign (leads_to_room place_2__b meetingroom) true))
        (probabilistic  0.2000  (assign (contains-a-person-prior room_0__a1) true))
        (probabilistic  0.2788  (assign (leads_to_room place_2__b office) true))
        (probabilistic  0.8695  (assign (leads_to_room place_3__b corridor) true))
        (probabilistic  0.8663  (assign (leads_to_room place_4__b corridor) true))
        (probabilistic  0.8688  (assign (leads_to_room place_6__b corridor) true))
        (probabilistic  0.2648  (assign (leads_to_room place_6__b office) true))
        (probabilistic  0.2650  (assign (leads_to_room place_3__b meetingroom) true))
)
...
(move_direct robot_0__c place_3__b place_2__b place_0__b), EXECUTABLE
(move robot_0__c place_0__b place_3__b), EXECUTABLE
(move_direct robot_0__c place_4__b place_0__b place_1__b), EXECUTABLE
...
(search_for_object_in_room robot_0__c magazine room_0__a1 place_1__b visualobject2), EXECUTABLE
(goal ), EXECUTABLE
END_PLAN
actions:
0: SUCCEEDED init 
...
9: PENDING move_direct 0:C@spatial.sa 4:B@spatial.sa 0:B@spatial.sa 1:B@spatial.sa
10: PENDING move 0:C@spatial.sa 1:B@spatial.sa 4:B@spatial.sa
11: PENDING create_cones_in_room 0:C@spatial.sa magazine 0:A1@coma 1:B@spatial.sa
12: PENDING search_for_object_in_room 0:C@spatial.sa magazine 0:A1@coma 1:B@spatial.sa visualobject2
13: PENDING goal 
links:
1 2 DEPENDS category 0:A1@coma MODALITY: poss meetingroom VALUE: true
1 4 THREATENS started  VALUE: true
12 13 DEPENDS related-to visualobject2 MODALITY: kd 0:C@spatial.sa VALUE: true
...
2 11 DEPENDS obj_exists magazine in 0:A1@coma MODALITY: poss true VALUE: true
2 3 DEPENDS obj_exists magazine in 0:A1@coma MODALITY: poss true VALUE: true
2 4 THREATENS started  VALUE: true
8 9 DEPENDS is-in 0:C@spatial.sa VALUE: 0:B@spatial.sa
3 4 THREATENS started  VALUE: true
3 12 DEPENDS relation visualobject2 MODALITY: poss in VALUE: true
3 12 DEPENDS related-to visualobject2 MODALITY: poss 0:A1@coma VALUE: true
9 10 DEPENDS is-in 0:C@spatial.sa VALUE: 4:B@spatial.sa
...
0 1 DEPENDS category 0:A1@coma MODALITY: committed  VALUE: false
0 1 DEPENDS started  VALUE: false
0 12 DEPENDS in-room 1:B@spatial.sa MODALITY: poss 0:A1@coma VALUE: true
0 12 DEPENDS done  VALUE: false
0 12 DEPENDS search_cost magazine in 0:A1@coma VALUE: 200.0
...
0 2 DEPENDS obj_exists magazine in 0:A1@coma MODALITY: committed  VALUE: false
0 2 DEPENDS obj_exists_general magazine MODALITY: committed  VALUE: false
0 2 DEPENDS p-obj_exists magazine in 0:A1@coma meetingroom VALUE: 0.800000082297
0 2 DEPENDS p-obj_exists magazine in 0:A1@coma meetingroom MODALITY: defined  VALUE: true
0 2 DEPENDS started  VALUE: false
0 8 DEPENDS done  VALUE: false
...
0 3 DEPENDS entity-exists visualobject2 MODALITY: committed  VALUE: false
0 3 DEPENDS is-virtual visualobject2 VALUE: true
0 10 DEPENDS connected 1:B@spatial.sa 4:B@spatial.sa VALUE: true
0 10 DEPENDS done  VALUE: false
0 13 DEPENDS label visualobject2 VALUE: magazine
0 9 DEPENDS connected 1:B@spatial.sa 4:B@spatial.sa VALUE: true
0 9 DEPENDS done  VALUE: false
...
0 11 DEPENDS not_fully_explored 0:A1@coma VALUE: false
11 12 DEPENDS cones_created magazine in 0:A1@coma VALUE: true
END_POPLAN
(define (problem cogxtask)
...
(:init  (= (associated-with person0) dummy-room)
        ...
        (is-virtual visualobject3)
        (is-virtual visualobject4)
        (probabilistic  0.1031  (assign (leads_to_room place_5__b office) true))
        (probabilistic  0.3074  (assign (leads_to_room place_1__b meetingroom) true))
        (probabilistic  0.0337  (assign (category room_0__a1) corridor)
                        0.3068  (assign (category room_0__a1) meetingroom)
                        0.6595  (assign (category room_0__a1) office)
        )
        (probabilistic  0.2596  (assign (leads_to_room place_4__b meetingroom) true))
        (probabilistic  0.8437  (assign (leads_to_room place_2__b corridor) true))
        (probabilistic  0.2596  (assign (leads_to_room place_4__b office) true))
        (probabilistic  0.3074  (assign (leads_to_room place_1__b office) true))
        (probabilistic  0.1031  (assign (leads_to_room place_5__b meetingroom) true))
        (probabilistic  0.2606  (assign (leads_to_room place_3__b office) true))
        (probabilistic  0.2604  (assign (leads_to_room place_6__b meetingroom) true))
        (probabilistic  0.7908  (assign (leads_to_room place_1__b corridor) true))
        (probabilistic  0.2788  (assign (leads_to_room place_2__b meetingroom) true))
        (probabilistic  0.2000  (assign (contains-a-person-prior room_0__a1) true))
        (probabilistic  0.3443  (assign (leads_to_room place_5__b corridor) true))
        (probabilistic  0.2788  (assign (leads_to_room place_2__b office) true))
        (probabilistic  0.8777  (assign (leads_to_room place_3__b corridor) true))
        (probabilistic  0.8745  (assign (leads_to_room place_4__b corridor) true))
        (probabilistic  0.8771  (assign (leads_to_room place_6__b corridor) true))
        (probabilistic  0.2604  (assign (leads_to_room place_6__b office) true))
        (probabilistic  0.2606  (assign (leads_to_room place_3__b meetingroom) true))
)
...
(move_direct robot_0__c place_2__b place_6__b place_5__b), EXECUTED
(move_direct robot_0__c place_3__b place_2__b place_0__b), EXECUTABLE
(move robot_0__c place_0__b place_3__b), EXECUTABLE
(move_direct robot_0__c place_4__b place_0__b place_1__b), EXECUTABLE
(move robot_0__c place_1__b place_4__b), EXECUTABLE
...
5: SUCCEEDED move_direct 0:C@spatial.sa 2:B@spatial.sa 6:B@spatial.sa 5:B@spatial.sa
6: PENDING move_direct 0:C@spatial.sa 3:B@spatial.sa 2:B@spatial.sa 0:B@spatial.sa
7: PENDING move 0:C@spatial.sa 0:B@spatial.sa 3:B@spatial.sa
8: PENDING move_direct 0:C@spatial.sa place_4__b 0:B@spatial.sa 1:B@spatial.sa
9: PENDING move 0:C@spatial.sa 1:B@spatial.sa place_4__b
10: PENDING create_cones_in_room 0:C@spatial.sa magazine 0:A1@coma 1:B@spatial.sa
11: PENDING search_for_object_in_room 0:C@spatial.sa magazine 0:A1@coma 1:B@spatial.sa visualobject2
12: PENDING goal 
links:
...
8 9 DEPENDS is-in 0:C@spatial.sa VALUE: place_4__b
6 7 DEPENDS is-in 0:C@spatial.sa VALUE: 3:B@spatial.sa
7 8 DEPENDS is-in 0:C@spatial.sa VALUE: 0:B@spatial.sa
3 11 DEPENDS relation visualobject2 MODALITY: poss in VALUE: true
3 11 DEPENDS related-to visualobject2 MODALITY: poss 0:A1@coma VALUE: true
3 4 THREATENS started  VALUE: true
...
0 2 DEPENDS obj_exists magazine in 0:A1@coma MODALITY: committed  VALUE: false
0 2 DEPENDS obj_exists_general magazine MODALITY: committed  VALUE: false
0 2 DEPENDS p-obj_exists magazine in 0:A1@coma meetingroom VALUE: 0.799999990286
0 2 DEPENDS p-obj_exists magazine in 0:A1@coma meetingroom MODALITY: defined  VALUE: true
0 2 DEPENDS started  VALUE: false
0 8 DEPENDS connected 1:B@spatial.sa place_4__b VALUE: true
0 8 DEPENDS done  VALUE: false
0 8 DEPENDS connected 0:B@spatial.sa 1:B@spatial.sa VALUE: true
0 12 DEPENDS label visualobject2 VALUE: magazine
0 6 DEPENDS done  VALUE: false
0 6 DEPENDS connected 2:B@spatial.sa 0:B@spatial.sa VALUE: true
0 6 DEPENDS connected 0:B@spatial.sa 3:B@spatial.sa VALUE: true
0 7 DEPENDS done  VALUE: false
0 7 DEPENDS connected 0:B@spatial.sa 3:B@spatial.sa VALUE: true
0 3 DEPENDS related-to visualobject2 MODALITY: committed  VALUE: false
...
0 1 DEPENDS category 0:A1@coma MODALITY: committed  VALUE: false
0 1 DEPENDS started  VALUE: false
0 9 DEPENDS connected 1:B@spatial.sa place_4__b VALUE: true
0 9 DEPENDS done  VALUE: false
0 5 DEPENDS done  VALUE: false
...
(:init  (= (associated-with person0) dummy-room)
        ...
        (is-virtual visualobject3)
        (is-virtual visualobject4)
        (probabilistic  0.1956  (assign (leads_to_room place_7__b office) true))
        (probabilistic  0.1031  (assign (leads_to_room place_5__b office) true))
        (probabilistic  0.3074  (assign (leads_to_room place_1__b meetingroom) true))
        (probabilistic  0.0343  (assign (category room_0__a1) corridor)
                        0.7240  (assign (category room_0__a1) meetingroom)
                        0.2418  (assign (category room_0__a1) office)
        )
        (probabilistic  0.6580  (assign (leads_to_room place_7__b corridor) true))
        (probabilistic  0.8437  (assign (leads_to_room place_2__b corridor) true))
        (probabilistic  0.3074  (assign (leads_to_room place_1__b office) true))
        (probabilistic  0.1031  (assign (leads_to_room place_5__b meetingroom) true))
        (probabilistic  0.1956  (assign (leads_to_room place_7__b meetingroom) true))
        (probabilistic  0.2608  (assign (leads_to_room place_3__b office) true))
        (probabilistic  0.2694  (assign (leads_to_room place_6__b meetingroom) true))
        (probabilistic  0.7908  (assign (leads_to_room place_1__b corridor) true))
        (probabilistic  0.2788  (assign (leads_to_room place_2__b meetingroom) true))
        (probabilistic  0.2000  (assign (contains-a-person-prior room_0__a1) true))
        (probabilistic  0.3443  (assign (leads_to_room place_5__b corridor) true))
        (probabilistic  0.2788  (assign (leads_to_room place_2__b office) true))
        (probabilistic  0.8773  (assign (leads_to_room place_3__b corridor) true))
        (probabilistic  0.8363  (assign (leads_to_room place_6__b corridor) true))
        (probabilistic  0.2694  (assign (leads_to_room place_6__b office) true))
        (probabilistic  0.2608  (assign (leads_to_room place_3__b meetingroom) true))
)
...
(__commit-object_existence_room-0 robot_0__c magazine in room_0__a1 meetingroom), EXECUTED
(__commit-sample_object_location-0 robot_0__c visualobject2 magazine in room_0__a1), EXECUTED
(move_direct robot_0__c place_3__b place_2__b place_0__b), EXECUTED
(move robot_0__c place_0__b place_3__b), EXECUTED
(move_direct robot_0__c place_7__b place_0__b place_1__b), EXECUTED
...
2: SUCCEEDED __commit-object_existence_room-0 0:C@spatial.sa magazine in 0:A1@coma meetingroom
3: SUCCEEDED __commit-sample_object_location-0 0:C@spatial.sa visualobject2 magazine in 0:A1@coma
4: SUCCEEDED move_direct 0:C@spatial.sa 3:B@spatial.sa 2:B@spatial.sa 0:B@spatial.sa
5: SUCCEEDED move 0:C@spatial.sa 0:B@spatial.sa 3:B@spatial.sa
6: SUCCEEDED move_direct 0:C@spatial.sa 7:B@spatial.sa 0:B@spatial.sa 1:B@spatial.sa
...
9: PENDING search_for_object_in_room 0:C@spatial.sa magazine 0:A1@coma 1:B@spatial.sa visualobject2
10: PENDING goal 
links:
...
0 6 DEPENDS connected 0:B@spatial.sa 1:B@spatial.sa VALUE: true
0 6 DEPENDS done  VALUE: false
0 8 DEPENDS in-room 1:B@spatial.sa MODALITY: poss 0:A1@coma VALUE: true
0 8 DEPENDS done  VALUE: false
0 8 DEPENDS not_fully_explored 0:A1@coma VALUE: false
0 4 DEPENDS done  VALUE: false
0 4 DEPENDS connected 2:B@spatial.sa 0:B@spatial.sa VALUE: true
0 4 DEPENDS is-in 0:C@spatial.sa VALUE: 2:B@spatial.sa
0 4 DEPENDS connected 0:B@spatial.sa 3:B@spatial.sa VALUE: true
0 3 DEPENDS related-to visualobject2 MODALITY: committed  VALUE: false
0 3 DEPENDS label visualobject2 VALUE: magazine
0 3 DEPENDS relation visualobject2 MODALITY: committed  VALUE: false
0 3 DEPENDS started  VALUE: false
...
0 2 DEPENDS obj_exists magazine in 0:A1@coma MODALITY: committed  VALUE: false
0 2 DEPENDS obj_exists_general magazine MODALITY: committed  VALUE: false
0 2 DEPENDS p-obj_exists magazine in 0:A1@coma meetingroom VALUE: 0.800000032933
0 2 DEPENDS p-obj_exists magazine in 0:A1@coma meetingroom MODALITY: defined  VALUE: true
0 2 DEPENDS started  VALUE: false
0 5 DEPENDS done  VALUE: false
0 5 DEPENDS connected 0:B@spatial.sa 3:B@spatial.sa VALUE: true
...
5 6 DEPENDS is-in 0:C@spatial.sa VALUE: 0:B@spatial.sa
2 4 THREATENS started  VALUE: true
2 3 DEPENDS obj_exists magazine in 0:A1@coma MODALITY: poss true VALUE: true
2 8 DEPENDS obj_exists magazine in 0:A1@coma MODALITY: poss true VALUE: true
...
(:init  (= (associated-with person0) dummy-room)
        ...
        (is-virtual visualobject4)
        (probabilistic  0.1031  (assign (leads_to_room place_5__b office) true))
        (probabilistic  0.1945  (assign (leads_to_room place_7__b office) true))
        (probabilistic  0.3074  (assign (leads_to_room place_1__b meetingroom) true))
        (probabilistic  0.0246  (assign (category room_0__a1) corridor)
                        0.8785  (assign (category room_0__a1) meetingroom)
                        0.0969  (assign (category room_0__a1) office)
        )
        (probabilistic  0.6601  (assign (leads_to_room place_7__b corridor) true))
        (probabilistic  0.3443  (assign (leads_to_room place_5__b corridor) true))
        (probabilistic  0.8437  (assign (leads_to_room place_2__b corridor) true))
        (probabilistic  0.3074  (assign (leads_to_room place_1__b office) true))
        (probabilistic  0.1031  (assign (leads_to_room place_5__b meetingroom) true))
        (probabilistic  0.1945  (assign (leads_to_room place_7__b meetingroom) true))
        (probabilistic  0.2596  (assign (leads_to_room place_3__b office) true))
        (probabilistic  0.2694  (assign (leads_to_room place_6__b meetingroom) true))
        (probabilistic  0.7908  (assign (leads_to_room place_1__b corridor) true))
        (probabilistic  0.2788  (assign (leads_to_room place_2__b meetingroom) true))
        (probabilistic  0.2000  (assign (contains-a-person-prior room_0__a1) true))
        (probabilistic  0.2788  (assign (leads_to_room place_2__b office) true))
        (probabilistic  0.8797  (assign (leads_to_room place_3__b corridor) true))
        (probabilistic  0.8363  (assign (leads_to_room place_6__b corridor) true))
        (probabilistic  0.2694  (assign (leads_to_room place_6__b office) true))
        (probabilistic  0.2596  (assign (leads_to_room place_3__b meetingroom) true))
)
...
(__commit-object_existence_room-0 robot_0__c magazine in room_0__a1 meetingroom), EXECUTED
(__commit-sample_object_location-0 robot_0__c visualobject2 magazine in room_0__a1), EXECUTED
(create_cones_in_room robot_0__c magazine room_0__a1 place_1__b), EXECUTED
(search_for_object_in_room robot_0__c magazine room_0__a1 place_1__b visualobject2), EXECUTABLE
(goal ), EXECUTABLE
END_PLAN
actions:
...
2: SUCCEEDED __commit-object_existence_room-0 0:C@spatial.sa magazine in 0:A1@coma meetingroom
3: SUCCEEDED __commit-sample_object_location-0 0:C@spatial.sa visualobject2 magazine in 0:A1@coma
4: SUCCEEDED create_cones_in_room 0:C@spatial.sa magazine 0:A1@coma 1:B@spatial.sa
5: PENDING search_for_object_in_room 0:C@spatial.sa magazine 0:A1@coma 1:B@spatial.sa visualobject2
6: PENDING goal 
links:
...
0 4 DEPENDS in-room 1:B@spatial.sa VALUE: 0:A1@coma
...
0 5 DEPENDS is-in 0:C@spatial.sa VALUE: 1:B@spatial.sa
0 5 DEPENDS in-room 1:B@spatial.sa VALUE: 0:A1@coma
0 5 DEPENDS label visualobject2 VALUE: magazine
0 2 DEPENDS obj_exists magazine in 0:A1@coma MODALITY: committed  VALUE: false
0 2 DEPENDS obj_exists_general magazine MODALITY: committed  VALUE: false
0 2 DEPENDS p-obj_exists magazine in 0:A1@coma meetingroom VALUE: 0.800000027139
0 2 DEPENDS p-obj_exists magazine in 0:A1@coma meetingroom MODALITY: defined  VALUE: true
0 2 DEPENDS started  VALUE: false
0 3 DEPENDS related-to visualobject2 MODALITY: committed  VALUE: false
0 3 DEPENDS label visualobject2 VALUE: magazine
...
3 5 DEPENDS related-to visualobject2 MODALITY: poss 0:A1@coma VALUE: true
3 4 THREATENS started  VALUE: true
1 2 DEPENDS category 0:A1@coma MODALITY: poss meetingroom VALUE: true
1 4 THREATENS started  VALUE: true
END_POPLAN
...
(:init  (= (associated-with person0) dummy-room)
        ...
        (= (p-obj_exists magazine in room_0__a1 meetingroom) 0.8000)
        (= (p-obj_exists magazine in room_0__a1 office) 0.1800)
        (= (p-visible conegroup_0__l) 0.0769)
        (= (p-visible conegroup_1__l) 0.2128)
        (= (p-visible conegroup_2__l) 0.1503)
        (= (p-visible conegroup_3__l) 0.0642)
        (= (p-visible conegroup_4__l) 0.0730)
        (= (p-visible conegroup_5__l) 0.1572)
        (= (p-visible conegroup_6__l) 0.1451)
        (= (p-visible conegroup_7__l) 0.1205)
        (= (placestatus place_0__b) trueplace)
        (= (placestatus place_1__b) trueplace)
        (= (placestatus place_2__b) trueplace)
        (= (placestatus place_3__b) trueplace)
...
(__commit-object_existence_room-0 robot_0__c magazine in room_0__a1 meetingroom), EXECUTED
(__commit-sample_object_location-0 robot_0__c visualobject2 magazine in room_0__a1), EXECUTED
(search_for_object_in_room robot_0__c magazine room_0__a1 place_1__b visualobject2), UNSUCCESSFUL
(goal ), EXECUTABLE
END_PLAN
actions:
0: SUCCEEDED init 
1: SUCCEEDED __commit-category-room_0__a1-meetingroom 0:C@spatial.sa
2: SUCCEEDED __commit-object_existence_room-0 0:C@spatial.sa magazine in 0:A1@coma meetingroom
3: SUCCEEDED __commit-sample_object_location-0 0:C@spatial.sa 0:Q@vision.sa magazine in 0:A1@coma
4: UNSUCCESSFUL search_for_object_in_room 0:C@spatial.sa magazine 0:A1@coma 1:B@spatial.sa 0:Q@vision.sa
5: PENDING goal 
links:
...
0 4 DEPENDS cg-related-to 3:L@binder VALUE: 0:A1@coma
...
3 4 DEPENDS related-to 0:Q@vision.sa MODALITY: poss 0:A1@coma VALUE: true
END_POPLAN
