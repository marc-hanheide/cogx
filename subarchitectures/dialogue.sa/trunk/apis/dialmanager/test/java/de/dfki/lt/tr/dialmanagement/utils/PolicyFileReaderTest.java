...
public class PolicyFileReaderTest {
	...
	public static String POLICYFILE = "apis/dialmanager/config/simplepolicy.txt";
	public static String OBSFILE = "apis/dialmanager/config/simpleobservations.txt";
	public static String ACTIONSFILE = "apis/dialmanager/config/simpleactions.txt";
