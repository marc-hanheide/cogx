...
public class ActionNode {
	 ...
	 */
	public ActionNode(String identifier, AbstractAction action, Collection<ObservationEdge> outgoingEdges) throws DialogueException {
	 ...
	 * used in the node
	 */
	public void addOutgoingEdges(Collection<ObservationEdge> edges) throws DialogueException {
		for (ObservationEdge edge : edges) {
