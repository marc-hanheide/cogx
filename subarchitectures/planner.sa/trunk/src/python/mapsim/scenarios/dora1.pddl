...
(:common
 ...
 (:init  (= (is-in dora)  p1a)
         ...
         (= (probability p1a cornflakes) 0.5)
         (= (probability p2a cornflakes) 0.5)
         (= (probability p1a table) 0.6)
         (= (probability p2a table) 0.4)
         (= (probability p1a mug) 0.6)
         (= (probability p2a mug) 0.4)
         (= (probability p1a oven) 0.1)
         (= (probability p2a oven) 0.9)

         (= (probability p1b cornflakes) 0.4)
         (= (probability p2b cornflakes) 0.6)
         (= (probability p1b table) 0.3)
         (= (probability p2b table) 0.7)
         (= (probability p1b mug) 0.3)
         (= (probability p2b mug) 0.7)
         (= (probability p1b oven) 0.8)
         (= (probability p2b oven) 0.2)
