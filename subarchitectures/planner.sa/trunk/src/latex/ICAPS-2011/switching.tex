...
therefor give the process in this mode a different reward model, which
...
decision-theoretic mode, we include another propositionally trivial
...
defined it for the sequential mode.
