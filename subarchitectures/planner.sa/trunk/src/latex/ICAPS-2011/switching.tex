...
next scheduled action is uncertain.  A contingent session then begins,
...
declaration in DTPDDL. Our approach uses that {\em underlying}
belief-state as: (1) the source of determinisations for sequential
planning, (2) the basis for switching, and (3) the source for state
abstraction in contingent sessions.
