...
probabilistic, e.g., $(\pp{probabilistic}~p_1 (T_1) .. p_n (T_n))$, or
(3) a conjunct over probabilistic and atomic terms. The root term is
conjunctive, and the leaves are atomic. For example, the starting
distribution for $\pp{R2D2}$ might be described thusly:
...
according to a recursive descent. 
