...
[ /Author (Moritz Goebelbecker, Charles Gretton, Richard Dearden)
/Title (A Switching Planner for Combined Task and Observation Planning)
/Subject (Proceedings of the Twenty-Fifth Conference on Artificial Intelligence)
...
/Title (A Switching Planner for Combined Task and Observation Planning)
/Subject (Proceedings of the Twenty-Fifth Conference on Artificial Intelligence)
/Author (Moritz Goebelbecker, Charles O. Gretton, Richard Dearden)
}
...
\author{
Moritz G{\"o}belbecker \\ Albert-Ludwigs-Universit{\"a}t Freiburg, Germany\\
goebelbe@informatik.uni-freiburg.de
\And
Charles O. Gretton, Richard Dearden,\\
...
\section{Propositionally Factored Decision-Theoretic Planning}
\input{prop-dtp.tex}
...
\small
\paragraph{Acknowledgements:} The research leading to these results has
