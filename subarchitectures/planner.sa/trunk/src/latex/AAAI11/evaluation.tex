...
13-objects, $|$states$|$$>\sim10^{48}$) to 6 (26-places, 21-objects,
$|$states$|$ $>10^{48}$). We experiment with a sensing model that is:
({\em reliable}) $0.1$ probability of false negative, ({\em
semi-reliable}) chance is $0.35$, and ({\em noisy}) chance is $0.4$.
...
2.3GHz AMD Opteron using one CPU core.}. The continual planning times
are reported in Figure~\ref{fig:results-time}, and the quality data in
