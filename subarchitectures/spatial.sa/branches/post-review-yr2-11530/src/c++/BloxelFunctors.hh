    ...
    */
    template <typename MapData>
        class BloxelMax{
            ...
            public:
                static FunctorType type() { return Read; }
                BloxelMax() : first(true) {};
                inline void operator()(MapData data, double size, double xPos, double yPos, double zPos){
                    if(first) { 
                        result = data; 
                        first = false;
                    } else { 
                ...
                MapData getResult() const { return result; };
    ...
    template <typename MapData>
        class BloxelEquals{
            ...
            public:
                ...
                BloxelEquals(MapData value) : value(value) {};
                inline MapData operator()(MapData & data, double size, double xPos, double yPos, double zPos) const {
                    data = value;
                };
        };
    ...
    */
    template <typename MapData>
        class BloxelAdd{
            ...
            public:
                ...
                BloxelAdd(MapData value) : value(value) {};
                inline MapData operator()(MapData & data, double size, double xPos, double yPos, double zPos) const {
                    data += value;
                };
        };
    ...
    template <typename MapData>
        class MakeObstacle{
            public:
                static FunctorType type() { return Replace; }
                inline void operator()(MapData &data, double size, double xPos, double yPos, double zPos) const {
    ...
    template <typename MapData>
        class isRegionFree{
            ...
            public:
                static FunctorType type() { return Read; }
                isRegionFree() { result = true; };
                bool getResult() { return result; };
                inline void operator()(const MapData &data, double size, double xPos, double yPos, double zPos) {
    ...
    template <typename MapData>
        class BloxelThreshold{
            private:
                MapData threshold;
            public:
                BloxelThreshold(MapData thr) : threshold(thr) {};
