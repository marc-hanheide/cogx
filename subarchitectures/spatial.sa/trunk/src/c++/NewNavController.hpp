...
public:
	...
	enum ReturnValues {
		RETVAL_OK = 0, RETVAL_ERROR = 1, RETVAL_GOALNOTFOUND = 2, RETVAL_NOPATH = 3
	};
...
public:
	...
	void setPoseProvider(PoseProvider &pp) {
		m_PP = &pp;
	}
	 ...
	 */
	void setPositionToleranceIntermediate(double tol) {
		m_InterGoalTol = tol;
	}
	 ...
	 * @see NewNavController::setPositionToleranceGateway
	 */
	void setPositionToleranceFinal(double tol) {
		m_FinalGoalTol = tol;
	}
	 ...
	 * @see NewNavController::setPositionToleranceFinal
	 */
	void setPositionToleranceGateway(double tol) {
		m_GatewayGoalTol = tol;
	}
	...
	void setFollowDistances(double dist, double backupDist,
		...
		if (goalDistToTarget >= 0)
			m_FollowBeforeTargetDist = goalDistToTarget;
	}
	 ...
	 */
	bool isOn() const {
		return m_TaskType != TASKTYPE_OFF;
	}
	 ...
	 */
	bool isStop() const {
		return m_TaskType == TASKTYPE_STOP;
	}
	 ...
	 */
	double getPositionToleranceIntermediate() const {
		return m_InterGoalTol;
	}
	 ...
	 * @see NewNavController::setPositionToleranceIntermediate
	 */
	double getPositionToleranceFinal() const {
		return m_FinalGoalTol;
	}
	 ...
	 * @see NewNavController::setPositionToleranceIntermediate
	 */
	double getPositionTolerancGateway() const {
		return m_GatewayGoalTol;
	}
	 ...
	 * is reached [rad]
	 */
	double getOrientationTolerance() const {
		return m_FinalGoalTolRot;
	}
	 ...
	 */
	void setUsePathTrimming(bool v) {
		m_UsePathTrimming = v;
	}
	 ...
	 */
	void setCanTrimGateways(bool v) {
		m_CanTrimGateways = v;
	}
	 ...
	 */
	bool isUsingPathTrimming() const {
		return m_UsePathTrimming;
	}
	 ...
	 * @see NewNavController::setUsePathTrimming
	 */
	void setMaxPathTrimDist(double d) {
		m_MaxTrimDist = d;
	}
	 ...
	 */
	double getProgressTimeout() const {
	 ...
	 * @see setFollowDistance
	 */
	int followPerson(int taskID, double x, double y, double dir, double speed,
			double visibility);
	 ...
	 * @return 0 if OK, else non-zero
	 */
	int execPath(int taskID, const std::list<NavGraphNode> &path, bool finalTurn);
...
protected:
	 ...
	 */
	void
			initTrimPath(const Cure::Pose3D &currPose, std::list<NavGraphNode> &path);
