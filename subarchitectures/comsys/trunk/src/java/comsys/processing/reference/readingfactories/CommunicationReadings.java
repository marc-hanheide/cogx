/** 
 The factory specifies possible readings for a communication construction. 
 The restrictor and scope are derived from the construction over 
 which the communication predicate scopes. 
...
public class CommunicationReadings 
	implements ReadingFactory 
{

	/** Cognition constructions have root sort: communication.*/ 
	
	private String sort = "communication"; 	
