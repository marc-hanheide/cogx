...
// ------------------------------------------------------
bool DataReader::readImage(PlaceData::ImagePtr image)
{
  if (!_useVision)
    return false;
...
// ------------------------------------------------------
bool DataReader::readImageInfo(std::string &iPath, PlaceData::ImagePtr image, bool checkFrameNo)
{
  if (!_useVision)
    return false;
...
// ------------------------------------------------------
bool DataReader::readLaserScan(PlaceData::LaserScanPtr scan, bool checkFrameNo)
{
  if (!_useLaser)
    return false;
...
// ------------------------------------------------------
bool DataReader::readOdometry(PlaceData::OdometryPtr odom, bool checkFrameNo)
{
  if (!_useOdometry)
    return false;
...
// ------------------------------------------------------
bool DataReader::readTarget(PlaceData::TargetPtr target, bool checkFrameNo)
{
  ...
  // Fill in missing fields
  target->status = PlaceData::DsValid;
...
// ------------------------------------------------------
bool DataReader::readPgmImage(PlaceData::ImagePtr image, std::string filePath)
{
