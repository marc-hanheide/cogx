...
public:
  ...
  void addOutputs(double x, double y, double theta, const PlaceData::ClassifierOutputs &outputs);

  /** Returns accumulated outputs. */
  void getAccumulatedOutputs(PlaceData::ClassifierOutputs &outputs, unsigned int &binCount) const;
...
private:
  ...
  void accumulateOutputs(PlaceData::ClassifierOutputs &accOutputs,
                         const PlaceData::ClassifierOutputs &outputs) const;

  void accumulateUnnormalizedOutputs(PlaceData::ClassifierOutputs &accOutputs,
...
private:
  ...
  {
    unsigned int count;
    PlaceData::ClassifierOutputs accOutputs;
  };
