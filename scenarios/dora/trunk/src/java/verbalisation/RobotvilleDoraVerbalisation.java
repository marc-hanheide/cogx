 ...
 * 
 */
public class RobotvilleDoraVerbalisation extends ManagedComponent implements
	...
	private static final TextGenerator<VisualObject> VISUAL_OBJECT_GENERATOR = new TextGenerator<VisualObject>() {
		...
		public String toText(VisualObject _i) {
			...
			return "something is wrong in "
					+ RobotvilleDoraVerbalisation.class.getSimpleName();
	...
	private static TextGenerator<PersonObservation> PERSONOBSERVATION_GEN = new TextGenerator<PersonObservation>() {
		@Override
		public String toText(PersonObservation _i) {
			StringBuilder sb = new StringBuilder();
			if (_i.existProb > 0.5)
				sb.append("I saw someone here... Hello you");
			else {
				sb.append("I cannot see any person here");
			}
			return sb.toString();
		}
	};
	...
	public RobotvilleDoraVerbalisation() {
	...
	public void start() {
		...
		m_verbals.verbaliseOnAddition(PersonObservation.class,
				PERSONOBSERVATION_GEN);
	...
	public void runComponent() {
		m_verbals
				.verbaliseCannedText("my name is dora and I welcome you to the robotville festival.");
	}
