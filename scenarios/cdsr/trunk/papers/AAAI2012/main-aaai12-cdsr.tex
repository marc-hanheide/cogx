...
(regionBoundarySegment CDSR9 \\
\hspace*{2em}(YMaxXFewestFn Room-Base) \\
\hspace*{2em}(YMinXFewestFn Room-Base)) \\
(regionBoundarySegment CDSR9 \\
\hspace*{2em}(YMinXFewestFn Room-Base) \\
...
\begin{figure}[h]
  ...
  \caption{Analogical mapping between five base expressions and three target expressions. }
