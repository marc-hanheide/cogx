...
import balt.core.connectors.push.primitive.interfaces.CharPushInterface.CharPushConnectorOut;

/**
 * @author nah
 */
public class CharRemotePushSenderImpl extends RemotePushSenderPOA
        implements CharPushConnectorOut {
     ...
     * 
     */
    public CharRemotePushSenderImpl() {
        super();
    }
