 ...
 * @author nah
 */
public class FloatRemotePullSenderImpl extends RemotePullSenderPOA
        implements FloatPullInterface.FloatPullConnectorOut {
     ...
     * 
     */
    public FloatRemotePullSenderImpl() {
        super();
    }
    ...
    public float pull(FrameworkQuery _query)
        ...
        if (m_out != null) {
            try {
                return RemoteDataTranslator.translateFloatFromAny(m_out
