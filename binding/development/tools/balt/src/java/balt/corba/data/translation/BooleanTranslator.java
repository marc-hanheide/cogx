 ...
 * @author nah
 */
public class BooleanTranslator  implements
FrameworkDataTranslator<Boolean>  {

    public Any translate(Boolean _data)
            throws FrameworkDataTranslatorException {
        Any a = ORB.init().create_any();
        a.insert_boolean(_data);
        return a;
    }
    ...
    // throws FrameworkDataTranslatorException {
    // Any a = ORB.init().create_any();
    // a.insert_boolean(_data.booleanValue());
    // return a;
    //    }

    public Boolean translate(Any _data)
            throws FrameworkDataTranslatorException {
        try {
            return _data.extract_boolean();
        }
     ...
     */
    public Class<Boolean> getTransClass() {
...
//     */
//    public Any translate(Boolean _data) throws FrameworkDataTranslatorException {
//        try {
//            return new Boolean(_data.extract_boolean());
//        }
//        catch (BAD_OPERATION e) {
//            throw new FrameworkDataTranslatorException(
//                "Unable to extract String from Any", e);
