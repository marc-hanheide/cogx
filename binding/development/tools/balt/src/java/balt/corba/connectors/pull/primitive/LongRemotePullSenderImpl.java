 ...
 * @author nah
 */
public class LongRemotePullSenderImpl extends RemotePullSenderPOA
        implements LongPullInterface.LongPullConnectorOut {
     ...
     * 
     */
    public LongRemotePullSenderImpl() {
        super();
    }
    ...
    public long pull(FrameworkQuery _query)
        ...
        if (m_out != null) {
            try {
                return RemoteDataTranslator.translateLongFromAny(m_out
