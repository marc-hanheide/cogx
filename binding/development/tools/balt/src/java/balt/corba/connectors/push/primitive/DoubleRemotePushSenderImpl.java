...
import balt.core.connectors.push.primitive.interfaces.DoublePushInterface.DoublePushConnectorOut;

/**
 * @author nah
 */
public class DoubleRemotePushSenderImpl extends RemotePushSenderPOA
        implements DoublePushConnectorOut {
     ...
     * 
     */
    public DoubleRemotePushSenderImpl() {
        super();
    }
