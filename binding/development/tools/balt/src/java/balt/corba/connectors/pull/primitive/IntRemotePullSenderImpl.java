 ...
 * @author nah
 */
public class IntRemotePullSenderImpl extends RemotePullSenderPOA
        implements IntPullInterface.IntPullConnectorOut {
     ...
     * 
     */
    public IntRemotePullSenderImpl() {
        super();
    }
    ...
    public int pull(FrameworkQuery _query)
        ...
        if (m_out != null) {
            try {
                return RemoteDataTranslator.translateIntFromAny(m_out
