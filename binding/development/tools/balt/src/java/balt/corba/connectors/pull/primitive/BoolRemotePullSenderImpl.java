 ...
 * @author nah
 */
public class BoolRemotePullSenderImpl extends RemotePullSenderPOA
        implements BoolPullInterface.BoolPullConnectorOut {
     ...
     * 
     */
    public BoolRemotePullSenderImpl() {
        super();
    }
    ...
    public boolean pull(FrameworkQuery _query)
        ...
        if (m_out != null) {
            try {
                return RemoteDataTranslator.translateBoolFromAny(m_out
