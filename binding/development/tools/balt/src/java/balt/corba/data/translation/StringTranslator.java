 ...
 * @author nah
 */
public class StringTranslator implements
        FrameworkDataTranslator<String> {

    public StringTranslator() {}

    public Any translate(String _data)
            throws FrameworkDataTranslatorException {
        Any a = ORB.init().create_any();
        a.insert_string(_data);
        return a;
    }

    public String translate(Any _data)
            throws FrameworkDataTranslatorException {
        try {
            return _data.extract_string();
        }
     ...
     */
    public Class<String> getTransClass() {
        return String.class;
    }
