...
import balt.core.connectors.push.primitive.interfaces.BoolPushInterface.BoolPushConnectorOut;

/**
 * @author nah
 */
public class BoolRemotePushSenderImpl extends RemotePushSenderPOA
        implements BoolPushConnectorOut {
     ...
     * 
     */
    public BoolRemotePushSenderImpl() {
        super();
    }
