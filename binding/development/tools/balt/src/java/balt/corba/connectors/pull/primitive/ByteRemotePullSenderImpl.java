 ...
 * @author nah
 */
public class ByteRemotePullSenderImpl extends RemotePullSenderPOA
        implements BytePullInterface.BytePullConnectorOut {
     ...
     * 
     */
    public ByteRemotePullSenderImpl() {
        super();
    }
    ...
    public byte pull(FrameworkQuery _query)
        ...
        if (m_out != null) {
            try {
                return RemoteDataTranslator.translateByteFromAny(m_out
