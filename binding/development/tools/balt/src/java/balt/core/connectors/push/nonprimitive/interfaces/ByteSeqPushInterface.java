 ...
 * @author nah
 */
public interface ByteSeqPushInterface {

    public interface ByteSeqSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                ByteSeqPushInterface.ByteSeqPushConnectorOut _out);

    }

    public interface ByteSeqPushReceiver extends PushReceiver {
    ...
    public interface ByteSeqPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                ByteSeqPushReceiver _pr);
    }

    public interface ByteSeqPushConnectorOut extends PushConnectorOut {
    ...
    public interface ByteSeqPushConnector extends PushConnector,
            ByteSeqPushConnectorOut, ByteSeqPushConnectorRegister {
