 ...
 * @author nah
 */
public interface CharSeqPushInterface {

    public interface CharSeqSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                CharSeqPushInterface.CharSeqPushConnectorOut _out);

    }

    public interface CharSeqPushReceiver extends PushReceiver {
    ...
    public interface CharSeqPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                CharSeqPushReceiver _pr);
    }

    public interface CharSeqPushConnectorOut extends PushConnectorOut {
    ...
    public interface CharSeqPushConnector extends PushConnector,
            CharSeqPushConnectorOut, CharSeqPushConnectorRegister {
