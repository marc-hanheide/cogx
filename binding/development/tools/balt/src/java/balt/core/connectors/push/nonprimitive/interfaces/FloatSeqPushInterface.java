 ...
 * @author nah
 */
public interface FloatSeqPushInterface {

    public interface FloatSeqSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                FloatSeqPushInterface.FloatSeqPushConnectorOut _out);

    }

    public interface FloatSeqPushReceiver extends PushReceiver {
    ...
    public interface FloatSeqPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                FloatSeqPushReceiver _pr);
    }

    public interface FloatSeqPushConnectorOut extends PushConnectorOut {
    ...
    public interface FloatSeqPushConnector extends PushConnector,
            FloatSeqPushConnectorOut, FloatSeqPushConnectorRegister {
