 ...
 * @author nah
 */
public interface DoubleSeqPushInterface {

    public interface DoubleSeqSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                DoubleSeqPushInterface.DoubleSeqPushConnectorOut _out);

    }

    public interface DoubleSeqPushReceiver extends PushReceiver {
    ...
    public interface DoubleSeqPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                DoubleSeqPushReceiver _pr);
    }

    public interface DoubleSeqPushConnectorOut extends PushConnectorOut {
    ...
    public interface DoubleSeqPushConnector extends PushConnector,
            DoubleSeqPushConnectorOut, DoubleSeqPushConnectorRegister {
