 ...
 * @author nah
 */
public interface BoolPushInterface {

    public interface BoolPushConnector extends PushConnector,
            BoolPushConnectorOut, BoolPushConnectorRegister {

    }

    public interface BoolPushConnectorOut extends PushConnectorOut {
    ...
    public interface BoolPushConnectorRegister extends
         ...
         *            this connector.
         */
        public abstract void registerPushReceiver(BoolPushReceiver _pr);
    }

    public interface BoolPushReceiver extends PushReceiver {
    ...
    public interface BoolSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                BoolPushInterface.BoolPushConnectorOut _out);
