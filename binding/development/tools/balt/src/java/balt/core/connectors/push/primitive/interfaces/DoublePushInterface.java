 ...
 * @author nah
 */
public interface DoublePushInterface {

    public interface DoublePushConnector extends PushConnector,
            DoublePushConnectorOut, DoublePushConnectorRegister {

    }

    public interface DoublePushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, double _data);
    }

    public interface DoublePushConnectorRegister extends
         ...
         *            this connector.
         */
        public abstract void registerPushReceiver(DoublePushReceiver _pr);
    }

    public interface DoublePushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, double _o);
    }

    public interface DoubleSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                DoublePushInterface.DoublePushConnectorOut _out);
