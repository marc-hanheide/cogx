 ...
 * @author nah
 */
public interface LongSeqPushInterface {

    public interface LongSeqSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                LongSeqPushInterface.LongSeqPushConnectorOut _out);

    }

    public interface LongSeqPushReceiver extends PushReceiver {
    ...
    public interface LongSeqPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                LongSeqPushReceiver _pr);
    }

    public interface LongSeqPushConnectorOut extends PushConnectorOut {
    ...
    public interface LongSeqPushConnector extends PushConnector,
            LongSeqPushConnectorOut, LongSeqPushConnectorRegister {
