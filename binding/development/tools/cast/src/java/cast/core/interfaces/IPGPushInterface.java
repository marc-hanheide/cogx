 ...
 * @author nah
 */
public interface IPGPushInterface {

    public interface IPGPushConnector extends PushConnector,
            IPGPushInterface.IPGPushConnectorOut,
            IPGPushInterface.IPGPushConnectorRegister {

    }

    public interface IPGPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, InformationProcessingTask _data);
    }

    public interface IPGPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                IPGPushInterface.IPGPushReceiver _pr);
    }

    public interface IPGPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, InformationProcessingTask _data);
    }

    public interface IPGPushSender extends PushSender {
