 ...
 * @author nah
 */
public interface WMCFPushInterface {

    public interface WMCFPushConnector extends PushConnector,
            WMCFPushInterface.WMCFPushConnectorOut,
            WMCFPushInterface.WMCFPushConnectorRegister {

    }

    public interface WMCFPushConnectorOut extends PushConnectorOut {
    ...
    public interface WMCFPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                WMCFPushInterface.WMCFPushReceiver _pr);
    }

    public interface WMCFPushReceiver extends PushReceiver {
    ...
    public interface WMCFPushSender extends PushSender {
