 ...
 * @author nah
 */
public interface CWMEPushInterface {

    public interface CWMEPushConnector extends PushConnector,
            CWMEPushInterface.CWMEPushConnectorOut,
            CWMEPushInterface.CWMEPushConnectorRegister {

    }

    public interface CWMEPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, CASTWorkingMemoryEntry _data);
    }

    public interface CWMEPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                CWMEPushInterface.CWMEPushReceiver _pr);
    }

    public interface CWMEPushReceiver extends PushReceiver {
    ...
    public interface CWMEPushSender extends PushSender {
