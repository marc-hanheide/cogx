 ...
 * @author nah
 */
public interface TGPushInterface {

    public interface TGPushConnector extends PushConnector,
            TGPushInterface.TGPushConnectorOut,
            TGPushInterface.TGPushConnectorRegister {

    }

    public interface TGPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, TaskGoal _data);
    }

    public interface TGPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                TGPushInterface.TGPushReceiver _pr);
    }

    public interface TGPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, TaskGoal _data);
    }

    public interface TGPushSender extends PushSender {
