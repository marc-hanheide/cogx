 ...
 * @author nah
 */
public interface CWMELPushInterface {

    public interface CWMELPushConnector extends PushConnector,
            CWMELPushConnectorOut, CWMELPushConnectorRegister {
    }

    public interface CWMELPushConnectorOut extends PushConnectorOut {
    ...
    public interface CWMELPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                CWMELPushInterface.CWMELPushReceiver _pr);
    }

    public interface CWMELPushReceiver extends PushReceiver {
    ...
    public interface CWMELPushSender extends PushSender {
