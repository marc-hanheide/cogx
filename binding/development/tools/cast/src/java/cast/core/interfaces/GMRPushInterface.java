 ...
 * @author nah
 */
public interface GMRPushInterface {

    public interface GMRPushConnector extends PushConnector,
            GMRPushInterface.GMRPushConnectorOut,
            GMRPushInterface.GMRPushConnectorRegister {

    }

    public interface GMRPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, TaskManagementResult _data);
    }

    public interface GMRPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                GMRPushInterface.GMRPushReceiver _pr);
    }

    public interface GMRPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, TaskManagementResult _data);
    }

    public interface GMRPushSender extends PushSender {
