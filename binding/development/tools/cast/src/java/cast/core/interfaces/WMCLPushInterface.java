 ...
 * @author nah
 */
public interface WMCLPushInterface {

    public interface WMCLPushConnector extends PushConnector,
            WMCLPushInterface.WMCLPushConnectorOut,
            WMCLPushInterface.WMCLPushConnectorRegister {

    }

    public interface WMCLPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, WorkingMemoryChange[] _data);
    }

    public interface WMCLPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                WMCLPushInterface.WMCLPushReceiver _pr);
    }

    public interface WMCLPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, WorkingMemoryChange[] _data);
    }

    public interface WMCLPushSender extends PushSender {
