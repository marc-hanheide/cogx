...
import cast.cdl.WorkingMemoryEntryHelper;

/**
 * @author nah
 */
public class WMETranslator implements
    ...
    public TCKind getTCKind() {
        return WorkingMemoryEntryHelper.type().kind();
    }
    ...
    public Any translate(WorkingMemoryEntry _data)
        ...
        WorkingMemoryEntryHelper.insert(a, _data);
        return a;
    }
    ...
    public WorkingMemoryEntry translate(Any _data)
            throws FrameworkDataTranslatorException {
        return WorkingMemoryEntryHelper.extract(_data);
    }
