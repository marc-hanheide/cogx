...
public class ChangeFilterFactory {
	...
	public static WorkingMemoryChangeFilter createAddressFilter(
		...
		return createAddressFilter(_wma.m_id, _wma.m_subarchitecture,
				_operation);
	}
	 ...
	 */
	public static <Type> WorkingMemoryChangeFilter createChangeFilter(
	...
	public static WorkingMemoryChangeFilter createChangeFilter(String _type,
		...
		return new WorkingMemoryChangeFilter(_op, _src,
				...
				_restriction, WorkingMemoryOperation.ADD, "");
	 ...
	 * architecture
	 */
	public static <Type> WorkingMemoryChangeFilter createGlobalTypeFilter(
			Class<Type> _cls) {
	...
	public static <Type> WorkingMemoryChangeFilter createGlobalTypeFilter(
		...
		return createTypeFilter(_cls, _operation, FilterRestriction.ALL_SA);
	}
	 ...
	 */
	public static <Type> WorkingMemoryChangeFilter createLocalTypeFilter(
			Class<Type> _cls) {
	...
	public static <Type> WorkingMemoryChangeFilter createLocalTypeFilter(
			Class<Type> _cls, WorkingMemoryOperation _operation) {
		return createTypeFilter(_cls, _operation, FilterRestriction.LOCAL_SA);
	}
	...
	public static <Type> WorkingMemoryChangeFilter createSourceFilter(
			Class<Type> _cls, String _component) {
		return createChangeFilter(_cls, WorkingMemoryOperation.WILDCARD,
				_component, "", "", FilterRestriction.ALL_SA);
	}
	 ...
	 * given restriction.
	 */
	public static <Type> WorkingMemoryChangeFilter createTypeFilter(
