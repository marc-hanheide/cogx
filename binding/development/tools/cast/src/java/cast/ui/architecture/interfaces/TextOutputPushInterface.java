 ...
 * @author nah
 */
public interface TextOutputPushInterface {

    public interface TextOutputPushConnector extends PushConnector,
            TextOutputPushConnectorOut, TextOutputPushConnectorRegister {

    }

    public interface TextOutputPushConnectorOut extends
            PushConnectorOut {
         ...
         */
        public abstract void push(String _src, TextOutput _data);
    }

    public interface TextOutputPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                TextOutputPushInterface.TextOutputPushReceiver _pr);
    }

    public interface TextOutputPushReceiver extends PushReceiver {
    ...
    public interface TextOutputPushSender extends PushSender {
