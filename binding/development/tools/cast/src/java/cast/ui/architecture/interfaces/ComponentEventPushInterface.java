 ...
 * @author nah
 */
public interface ComponentEventPushInterface {

    public interface ComponentEventPushConnector extends PushConnector,
            ComponentEventPushConnectorOut, ComponentEventPushConnectorRegister {

    }

    public interface ComponentEventPushConnectorOut extends
            PushConnectorOut {
         ...
         */
        public abstract void push(String _src, ComponentEvent _data);
    }

    public interface ComponentEventPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                ComponentEventPushInterface.ComponentEventPushReceiver _pr);
    }

    public interface ComponentEventPushReceiver extends PushReceiver {
    ...
    public interface ComponentEventPushSender extends PushSender {
