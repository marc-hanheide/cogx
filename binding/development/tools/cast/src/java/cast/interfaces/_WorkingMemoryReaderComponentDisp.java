...
public abstract class _WorkingMemoryReaderComponentDisp extends Ice.ObjectImpl implements WorkingMemoryReaderComponent
{
    protected void
    ...
    ___receiveChangeEvent(WorkingMemoryReaderComponent __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
