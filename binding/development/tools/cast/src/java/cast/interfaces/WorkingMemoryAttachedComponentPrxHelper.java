...
public final class WorkingMemoryAttachedComponentPrxHelper extends Ice.ObjectPrxHelperBase implements WorkingMemoryAttachedComponentPrx
{
    public void
    beat()
    {
    ...
    beat(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _WorkingMemoryAttachedComponentDel __del = (_WorkingMemoryAttachedComponentDel)__delBase;
                __del.beat(__ctx);
                return;
            }
    ...
    public static WorkingMemoryAttachedComponentPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        WorkingMemoryAttachedComponentPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (WorkingMemoryAttachedComponentPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::cast::interfaces::WorkingMemoryAttachedComponent"))
                {
                    WorkingMemoryAttachedComponentPrxHelper __h = new WorkingMemoryAttachedComponentPrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::cast::interfaces::WorkingMemoryAttachedComponent", __ctx))
                {
                    WorkingMemoryAttachedComponentPrxHelper __h = new WorkingMemoryAttachedComponentPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::cast::interfaces::WorkingMemoryAttachedComponent"))
                {
                    WorkingMemoryAttachedComponentPrxHelper __h = new WorkingMemoryAttachedComponentPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::cast::interfaces::WorkingMemoryAttachedComponent", __ctx))
                {
                    WorkingMemoryAttachedComponentPrxHelper __h = new WorkingMemoryAttachedComponentPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _WorkingMemoryAttachedComponentDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _WorkingMemoryAttachedComponentDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, WorkingMemoryAttachedComponentPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            WorkingMemoryAttachedComponentPrxHelper result = new WorkingMemoryAttachedComponentPrxHelper();
