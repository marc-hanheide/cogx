...
public final class _TaskManagerDelM extends Ice._ObjectDelM implements _TaskManagerDel
{
    public void
    ...
    addManagedComponent(ManagedComponentPrx comp, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("addManagedComponent", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
                IceInternal.BasicStream __os = __og.os();
                ManagedComponentPrxHelper.__write(__os, comp);
            }
            catch(Ice.LocalException __ex)
            {
                __og.abort(__ex);
    ...
    proposeTask(String component, String taskID, String taskName, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("proposeTask", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
    ...
    retractTask(String component, String taskID, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("retractTask", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
    ...
    taskComplete(String component, String taskID, cast.cdl.TaskOutcome outcome, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("taskComplete", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
