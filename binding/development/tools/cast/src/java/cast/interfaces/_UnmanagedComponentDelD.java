...
public final class _UnmanagedComponentDelD extends Ice._ObjectDelD implements _UnmanagedComponentDel
{
    public void
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    UnmanagedComponent __servant = null;
                    try
                    {
                        __servant = (UnmanagedComponent)__obj;
                    }
