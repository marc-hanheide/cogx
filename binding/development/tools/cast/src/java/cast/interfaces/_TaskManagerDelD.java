...
public final class _TaskManagerDelD extends Ice._ObjectDelD implements _TaskManagerDel
{
    public void
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    TaskManager __servant = null;
                    try
                    {
                        __servant = (TaskManager)__obj;
                    }
    ...
    public void
    addManagedComponent(final ManagedComponentPrx comp, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "addManagedComponent", Ice.OperationMode.Normal, __ctx);
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __servant.addManagedComponent(comp, __current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
    ...
    public void
    proposeTask(final String component, final String taskID, final String taskName, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "proposeTask", Ice.OperationMode.Normal, __ctx);
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __servant.proposeTask(component, taskID, taskName, __current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
    ...
    public void
    retractTask(final String component, final String taskID, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "retractTask", Ice.OperationMode.Normal, __ctx);
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __servant.retractTask(component, taskID, __current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
    ...
    public void
    taskComplete(final String component, final String taskID, final cast.cdl.TaskOutcome outcome, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "taskComplete", Ice.OperationMode.Normal, __ctx);
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __servant.taskComplete(component, taskID, outcome, __current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
