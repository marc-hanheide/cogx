...
public class _UnmanagedComponentTie extends _UnmanagedComponentDisp implements Ice.TieBase
{
    public
    _UnmanagedComponentTie()
    {
    }

    public
    _UnmanagedComponentTie(_UnmanagedComponentOperations delegate)
    {
    ...
    {
        _ice_delegate = (_UnmanagedComponentOperations)delegate;
    }
    ...
    equals(java.lang.Object rhs)
    {
        ...
        if(!(rhs instanceof _UnmanagedComponentTie))
        {
            return false;
        }

        return _ice_delegate.equals(((_UnmanagedComponentTie)rhs)._ice_delegate);
    }
    ...
    private _UnmanagedComponentOperations _ice_delegate;
}
