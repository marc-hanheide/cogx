...
#ifndef PERMISSION_EXCEPTION_H_
#define PERMISSION_EXCEPTION_H_
...
class PermissionException : public WMException {
  std::string _what;

 public:

  PermissionException(const cast::cdl::WorkingMemoryAddress& _wma, 
