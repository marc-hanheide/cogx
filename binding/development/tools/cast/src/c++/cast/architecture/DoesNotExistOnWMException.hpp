...
#ifndef DOESNOTEXISTONWM_EXCEPTION_H_
#define DOESNOTEXISTONWM_EXCEPTION_H_
...
class DoesNotExistOnWMException : public WMException {
  std::string _what;

 public:

  DoesNotExistOnWMException(const cast::cdl::WorkingMemoryAddress& _wma, 
