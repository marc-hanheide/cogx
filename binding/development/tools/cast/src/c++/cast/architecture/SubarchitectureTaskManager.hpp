...
/**
 * Abstract class for a subarchitecture task manager. This still uses a
 * fairly threading-heavy approach that needs to be revised.
 * 
 * @author nah
 */
class SubarchitectureTaskManager: 
  ...
  public PushReceiver<cdl::InformationProcessingTask>,
  public PushReceiver<std::string>,
  public PushReceiver<cdl::TaskResult>,
  public PushReceiver<cdl::TaskDescriptionList>,
  public PushSender<cdl::TaskManagementResult>
