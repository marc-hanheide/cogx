...
#ifndef SUBARCHITECTUREPROCESS_EXCEPTION_H_
#define SUBARCHITECTUREPROCESS_EXCEPTION_H_
...
class SubarchitectureProcessException : public CASTException {
  std::string _what;

 public:
  SubarchitectureProcessException() throw() {};
  SubarchitectureProcessException(const char *file, const char *function, int line,
				  const char *format, ...) throw() ;
  virtual ~SubarchitectureProcessException() throw() {}
