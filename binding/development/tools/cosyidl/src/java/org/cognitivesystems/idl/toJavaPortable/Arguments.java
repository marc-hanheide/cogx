...
// -F46082.51<daz> Transferred -m, -mmin, mall, -mdepend options to org.cognitivesystems.idl.toJava
...
import org.cognitivesystems.idl.InvalidArgument;


/**
 *
 **/
public class Arguments extends org.cognitivesystems.idl.Arguments
{
  /**
