...
import org.cognitivesystems.repr.lf.*;
    ...
    implements UPReqHandler
{
	...
	private Element editFeatures(LogicalForm input,LFNominal nom,String feature,Element el) {
		...
		org.cognitivesystems.repr.lf.autogen.LFEssentials.Feature[] feats = nom.feats;
	...
	if (helper.feats.length > 0) {
	    Iterator<org.cognitivesystems.repr.lf.autogen.LFEssentials.Feature> iter = 
