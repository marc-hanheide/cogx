...
/** 
The class <b>QColorToProxyFactory</b> implements the  mapping 
for producing a proxy, or a collection of proxies and proxy relations, 
for Q-COLOR type nominals. 
...
public class QPhysicalProxyFactory 
	...
	
{
	...
	*/
	...
	{  
		...
		proxyStructure.setFeature("State",nom.prop.prop);							
