...
public class SymbolicProxyFactory 
	extends AbstractProxyFactory
{
	...
	*/
	...
	{  
		...
		{
			SymbolicCallProxyFactory knowPF = new SymbolicCallProxyFactory();
			...
			System.err.println("Symbolic Factory is being called for an unknown verb ["+verb+"]");
			// System.exit(0);
		} // end if..else 
