...
/** 
The class <b>QSizeProxyFactory</b> implements the  mapping 
for producing a proxy, or a collection of proxies and proxy relations, 
for Q-SIZE type nominals. 
...
public class QSizeProxyFactory 
	...
	
{
	...
	*/
	...
	{  
		...
		proxyStructure.setFeature("Size",nom.prop.prop);							
