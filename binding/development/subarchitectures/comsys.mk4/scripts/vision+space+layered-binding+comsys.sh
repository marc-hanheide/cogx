clear
echo  ========================================================
echo  Comsys.mk4 [ vision+space+binding+comsys ] 
echo  --------------------------------------------------------
...
echo     - testbed visual scene VST4 [ red mug, blue ball, white mug, red ball ]
echo     - connected to binding.sa
echo 
display $COMSYS/config/visualscenes/vst4.png
echo 
...
java -Djava.library.path=$CODE_HOME/output/lib -classpath $PELLET_ROOT/lib/pellet.jar:$PELLET_ROOT/lib/aterm-java-1.6.jar:$OWLAPI_ROOT/lib/owlapi-api.jar:$OWLAPI_ROOT/lib/owlapi-apibinding.jar:$CODE_HOME/output/classes/:$CODE_HOME/tools/openccg/lib/ cast.server.CASTProcessServer -h localhost -f $CODE_HOME/subarchitectures/comsys.mk4/config/test-configurations/vision+space+layered-binding+comsys-SYS.cast
