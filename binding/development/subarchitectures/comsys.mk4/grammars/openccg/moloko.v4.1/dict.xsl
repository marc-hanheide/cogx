...
<entry pred="correct" stem="correct__q-attitude"  pos="ADJ" class="q-attitude">
  <word form="correct" macros="@degree.base"/>
  <word form="more_correct" macros="@degree.comparative"/>
  <word form="most_correct" macros="@degree.superlative"/>
  <member-of family="adj"/>
</entry>

<entry pred="right" stem="right__q-attitude"  pos="ADJ" class="q-attitude">
  <word form="right" macros="@degree.base"/>
  <word form="more_right" macros="@degree.comparative"/>
  <word form="most_right" macros="@degree.superlative"/>
  <member-of family="adj"/>
</entry>

<entry pred="wrong" stem="wrong__q-attitude"  pos="ADJ" class="q-attitude">
  <word form="wrong" macros="@degree.base"/>
  <word form="more_wrong" macros="@degree.comparative"/>
  <word form="most_wrong" macros="@degree.superlative"/>
  <member-of family="adj"/>
</entry>
...
<entry pred="other" stem="other__q-position"  pos="ADJ" class="q-position">
...
<entry pred="finished" stem="finished__q-state"  pos="ADJ" class="q-state">
  <word form="finished" macros="@degree.base"/>
  <word form="--" macros="@degree.comparative"/>
  <word form="--" macros="@degree.superlative"/>
  <member-of family="adj"/>
</entry>
...
<entry pred="pizza" stem="pizza-sg"  pos="N" class="thing">
  <word form="pizza" macros="@pers.3rd"/>
  <member-of family="noun"/>
</entry>
<entry pred="pizza" stem="pizza-pl"  pos="N" class="thing">
  <word form="pizzas" macros="@pers.3rd"/>
  <member-of family="noun.plural"/>
</entry>
...
<entry pred="jug" stem="jug-sg"  pos="N" class="thing">
  <word form="jug" macros="@pers.3rd"/>
  <member-of family="noun"/>
</entry>
<entry pred="jug" stem="jug-pl"  pos="N" class="thing">
  <word form="jugs" macros="@pers.3rd"/>
  <member-of family="noun.plural"/>
</entry>
...
<entry pred="scenery" stem="scenery-sg"  pos="N" class="thing">
  <word form="scenery" macros="@pers.3rd"/>
  <word form="sceneries" macros="@pers.3rd"/>
  <member-of family="noun"/>
</entry>
<entry pred="scenery" stem="scenery-pl"  pos="N" class="thing">
  <word form="scenerys" macros="@pers.3rd"/>
  <word form="sceneriess" macros="@pers.3rd"/>
  <member-of family="noun.plural"/>
</entry>
...
<entry pred="interaction" stem="interaction-sg"  pos="N" class="e-event">
  <word form="interaction" macros="@pers.3rd"/>
  <member-of family="noun"/>
</entry>
<entry pred="interaction" stem="interaction-pl"  pos="N" class="e-event">
  <word form="interactions" macros="@pers.3rd"/>
  <member-of family="noun.plural"/>
</entry>
...
<entry pred="up" stem="up__m-manner"  pos="MOD" class="m-manner">
  <word form="up"/>
  <member-of family="mod-right.prep"/>
</entry>

<entry pred="over" stem="over__m-manner"  pos="MOD" class="m-manner">
  <word form="over"/>
  <member-of family="mod-right.prep"/>
</entry>

<entry pred="right" stem="right__m-manner"  pos="MOD" class="m-manner">
  <word form="right"/>
  <member-of family="mod-right.prep"/>
</entry>

<entry pred="really" stem="really__m-intensity"  pos="MOD" class="m-intensity">
  <word form="really"/>
  <member-of family="mod-right.adj"/>
</entry>

<entry pred="barely" stem="barely__m-intensity"  pos="MOD" class="m-intensity">
  <word form="barely"/>
  <member-of family="mod-right.adj"/>
</entry>

<entry pred="extremely" stem="extremely__m-intensity"  pos="MOD" class="m-intensity">
  <word form="extremely"/>
  <member-of family="mod-right.adj"/>
</entry>

<entry pred="too" stem="too__m-intensity"  pos="MOD" class="m-intensity">
  <word form="too"/>
  <member-of family="mod-right.adj"/>
</entry>
...
<entry pred="before" stem="before__m-time"  pos="MARKER" class="m-time">
  <word form="before"/>
  <member-of family="dep-clause-marker.time"/>
</entry>

<entry pred="after" stem="after__m-time"  pos="MARKER" class="m-time">
  <word form="after"/>
  <member-of family="dep-clause-marker.time"/>
</entry>

<entry pred="while" stem="while__m-time"  pos="MARKER" class="m-time">
  <word form="while"/>
  <member-of family="dep-clause-marker.time"/>
</entry>

<entry pred="until" stem="until__m-time"  pos="MARKER" class="m-time">
  <word form="until"/>
  <member-of family="dep-clause-marker.time"/>
</entry>

<entry pred="when" stem="when__m-time"  pos="MARKER" class="m-time">
  <word form="when"/>
  <member-of family="dep-clause-marker.time"/>
</entry>

<entry pred="since" stem="since__m-time"  pos="MARKER" class="m-time">
  <word form="since"/>
  <member-of family="dep-clause-marker.time"/>
</entry>
...
<entry pred="restart" stem="restart__action-non-motion"  pos="V" class="action-non-motion">
  <word form="restart" macros="@nonfin"/>
  <word form="restart" macros="@finite @pres @imp @pers.3rd-agr"/>
  <word form="restarting" macros="@vform.progr"/>
  <word form="restart" macros="@finite @pres @ind @pers.non-3rd-agr @num.sg-agr "/>
  <word form="restart" macros="@finite @pres @ind @num.pl-agr "/>
  <word form="restarts" macros="@finite @pres @ind @pers.3rd-agr @num.sg-agr"/>
  <word form="restarted" macros="@finite @past @ind"/>
  <member-of family="iv"/>
  <member-of family="tv"/>
</entry>
<entry pred="restart" stem="restart-NO-SUBJ__action-non-motion"  pos="V" class="action-non-motion">
  <word form="restart" macros="@finite @pres @imp-addressee"/>
  <member-of family="iv.NO-SUBJ"/>
  <member-of family="tv.NO-SUBJ"/>
</entry>
...
<entry pred="fetch" stem="fetch__action-non-motion"  pos="V" class="action-non-motion">
  <word form="fetch" macros="@nonfin"/>
  <word form="fetch" macros="@finite @pres @imp @pers.3rd-agr"/>
  <word form="fetching" macros="@vform.progr"/>
  <word form="fetch" macros="@finite @pres @ind @pers.non-3rd-agr @num.sg-agr "/>
  <word form="fetch" macros="@finite @pres @ind @num.pl-agr "/>
  <word form="fetches" macros="@finite @pres @ind @pers.3rd-agr @num.sg-agr"/>
  <word form="fetched" macros="@finite @past @ind"/>
  <member-of family="dtv"/>
  <member-of family="dtv.for-indobj"/>
</entry>
<entry pred="fetch" stem="fetch-NO-SUBJ__action-non-motion"  pos="V" class="action-non-motion">
  <word form="fetch" macros="@finite @pres @imp-addressee"/>
  <member-of family="dtv.NO-SUBJ"/>
  <member-of family="dtv.for-indobj.NO-SUBJ"/>
</entry>
...
<entry pred="memorize" stem="memorize__cognition"  pos="V" class="cognition">
  <word form="memorize" macros="@nonfin"/>
  <word form="memorize" macros="@finite @pres @imp @pers.3rd-agr"/>
  <word form="memorizing" macros="@vform.progr"/>
  <word form="memorize" macros="@finite @pres @ind @pers.non-3rd-agr @num.sg-agr "/>
  <word form="memorize" macros="@finite @pres @ind @num.pl-agr "/>
  <word form="memorizes" macros="@finite @pres @ind @pers.3rd-agr @num.sg-agr"/>
  <word form="memorized" macros="@finite @past @ind"/>
  <member-of family="tv"/>
</entry>
<entry pred="memorize" stem="memorize-NO-SUBJ__cognition"  pos="V" class="cognition">
  <word form="memorize" macros="@finite @pres @imp-addressee"/>
  <member-of family="tv.NO-SUBJ"/>
</entry>
...
<entry pred="observe" stem="observe__perception"  pos="V" class="perception">
  <word form="observe" macros="@nonfin"/>
  <word form="observe" macros="@finite @pres @imp @pers.3rd-agr"/>
  <word form="observing" macros="@vform.progr"/>
  <word form="observe" macros="@finite @pres @ind @pers.non-3rd-agr @num.sg-agr "/>
  <word form="observe" macros="@finite @pres @ind @num.pl-agr "/>
  <word form="observes" macros="@finite @pres @ind @pers.3rd-agr @num.sg-agr"/>
  <word form="observed" macros="@finite @past @ind"/>
  <member-of family="tv"/>
</entry>
<entry pred="observe" stem="observe-NO-SUBJ__perception"  pos="V" class="perception">
  <word form="observe" macros="@finite @pres @imp-addressee"/>
  <member-of family="tv.NO-SUBJ"/>
</entry>
...
<entry pred="now" stem="now__dis-connective"  pos="DU" class="dis-connective">
  <word form="now"/>
  <member-of family="dis-unit.connective"/>
</entry>

<entry pred="ok" stem="ok__dis-connective"  pos="DU" class="dis-connective">
  <word form="ok"/>
  <member-of family="dis-unit.connective"/>
</entry>

<entry pred="right" stem="right__dis-connective"  pos="DU" class="dis-connective">
  <word form="right"/>
  <member-of family="dis-unit.connective"/>
</entry>

<entry pred="alright" stem="alright__dis-connective"  pos="DU" class="dis-connective">
  <word form="alright"/>
  <member-of family="dis-unit.connective"/>
</entry>

<entry pred="so" stem="so__dis-connective"  pos="DU" class="dis-connective">
  <word form="so"/>
  <member-of family="dis-unit.connective"/>
</entry>
...
<entry pred="ah" stem="ah__dis-connective"  pos="DU" class="dis-connective">
  <word form="ah"/>
  <member-of family="dis-unit.connective"/>
</entry>

<entry pred="and" stem="and__dis-connective"  pos="DU" class="dis-connective">
  <word form="and"/>
  <member-of family="dis-unit.connective"/>
</entry>

<entry pred="first" stem="first__dis-connective"  pos="DU" class="dis-connective">
  <word form="first"/>
  <member-of family="dis-unit.connective"/>
</entry>

<entry pred="second" stem="second__dis-connective"  pos="DU" class="dis-connective">
  <word form="second"/>
  <member-of family="dis-unit.connective"/>
</entry>

<entry pred="next" stem="next__dis-connective"  pos="DU" class="dis-connective">
  <word form="next"/>
  <member-of family="dis-unit.connective"/>
</entry>

<entry pred="last" stem="last__dis-connective"  pos="DU" class="dis-connective">
  <word form="last"/>
  <member-of family="dis-unit.connective"/>
</entry>

<entry pred="then" stem="then__dis-connective"  pos="DU" class="dis-connective">
  <word form="then"/>
  <member-of family="dis-unit.connective"/>
</entry>

<entry pred="finally" stem="finally__dis-connective"  pos="DU" class="dis-connective">
  <word form="finally"/>
  <member-of family="dis-unit.connective"/>
</entry>
