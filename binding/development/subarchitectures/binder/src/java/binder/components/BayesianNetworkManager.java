...
public class BayesianNetworkManager extends ManagedComponent {
...
/**		Feature[] featuresToTest = new Feature[3];
		featuresToTest[0] = new Feature();
		featuresToTest[0].featlabel = "shape";
		featuresToTest[0].alternativeValues = new StringValue[2];
		featuresToTest[0].alternativeValues[0] = new StringValue(0.0f, "cylindrical");
		featuresToTest[0].alternativeValues[1] = new StringValue(0.0f, "spherical");


		featuresToTest[1] = new Feature();
		featuresToTest[1].featlabel = "obj_label";
		featuresToTest[1].alternativeValues = new StringValue[2];
		featuresToTest[1].alternativeValues[0] = new StringValue(0.0f, "mug");
		featuresToTest[1].alternativeValues[1] = new StringValue(0.0f, "ball");
		
		featuresToTest[2] = new Feature();
		featuresToTest[2].featlabel = "colour";
		featuresToTest[2].alternativeValues = new StringValue[2];
		featuresToTest[2].alternativeValues[0] = new StringValue(0.0f, "blue");
		featuresToTest[2].alternativeValues[1] = new StringValue(0.0f, "pink");
		
		for (int i = 0; i < featuresToTest.length; i++) {
			DiscreteProbabilityDistribution distrib = getPriorDistribution(featuresToTest);
			log(ProbabilityDistributionUtils.getDiscreteProbabilityDistributionPrettyPrint(distrib));
		}  */
	}
