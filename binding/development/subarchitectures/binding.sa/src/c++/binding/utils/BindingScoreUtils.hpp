...
BindingData::BindingScore defaultBindingScorePtr();

/// at least comparable and sticky...
BindingData::BindingScore defaultThresholdScorePtr();
...
boost::logic::tribool tribool_cast(BindingData::TriBool _tri);
BindingData::TriBool tribool_cast(boost::logic::tribool _tri);
