 ...
 * @version     $Revision: 1.30 $, $Date: 2005/10/13 18:20:29 $
 */
public class Realize
{
    ...
    public static void main(String[] args) throws Exception {
        ...
        int oldTimeLimit = prefs.getInt(Chart.TIME_LIMIT, Chart.NO_TIME_LIMIT);
        prefs.putBoolean(Edge.SHOW_COMPLETENESS, true);
        prefs.putBoolean(Edge.SHOW_BITSET, true);
        prefs.putInt(Chart.TIME_LIMIT, Chart.NO_TIME_LIMIT);
        ...
        prefs.putInt(Chart.TIME_LIMIT, oldTimeLimit);
    }
}
