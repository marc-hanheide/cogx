///////////////////////////////////////////////////////////////////////////////
// Copyright (C) 2003-5 Jason Baldridge, Gann Bierner, 
//                      University of Edinburgh (Michael White) and Gunes Erkan
// 
 ...
 * @author      Gunes Erkan
 * @version     $Revision: 1.20 $, $Date: 2005/10/20 17:30:30 $
 */
public class GFeatStruc extends HashMap<String,Object> implements FeatureStructure {
    ...
    public void deepMap(ModFcn mf) {
        for (Iterator attributes=keySet().iterator(); attributes.hasNext();) {
            Object val1 = getValue((String)attributes.next());
    ...
    public String toString() {
        ...
        String featsToShow = prefs.get(AbstractCat.FEATURES_TO_SHOW, "");
     ...
     * features of interest, prepended by underscores.
    ...
    public String getSupertagInfo() {
        ...
        Set supertagFeatures = Grammar.theGrammar.supertagFeatures;
    ...
    public int hashCode(TObjectIntHashMap varMap) {
        ...
        for (int i=0; i<keys.length; i++) {
            ...
            if (val instanceof Variable) {
                // see if var already there
                if (varMap.containsKey(val)) {
                    retval += varMap.get(val);
                }
                // otherwise add it
                else {
    ...
    public boolean equals(Object obj, TObjectIntHashMap varMap, TObjectIntHashMap varMap2) {
        ...
        for (Iterator<String> it = atts1.iterator(); it.hasNext(); ) {
            ...
            if (val instanceof Variable && val2 instanceof Variable) {
                if (varMap.get(val) != varMap2.get(val2)) return false;
            }
            else {
