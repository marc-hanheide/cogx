...
public final class _WordServerAsComponentDelD extends Ice._ObjectDelD implements _WordServerAsComponentDel
{
    public String
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        __initCurrent(__current, "getNewWord", Ice.OperationMode.Normal, __ctx);
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    WordServerAsComponent __servant = null;
                    try
                    {
                        __servant = (WordServerAsComponent)__obj;
                    }
                    catch(ClassCastException __ex)
                    {
                        throw new Ice.OperationNotExistException(__current.id, __current.facet, __current.operation);
                    }
                    __result.value = __servant.getNewWord(__current);
    ...
    public void
    setComponentManager(final cast.interfaces.ComponentManagerPrx man, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
    ...
    public void
    setTimeServer(final cast.interfaces.TimeServerPrx ts, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
