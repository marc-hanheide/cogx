...
class test_harness__CAST_SCAT_client_clone1 :
    public CAST_SCAT::procedure_implementation<test_harness__CAST_SCAT_client_clone1>,
    public CAST_SCAT::procedure_call<>
{
public:
    typedef CAST_SCAT::procedure_implementation<test_harness__CAST_SCAT_client_clone1> Implement;
