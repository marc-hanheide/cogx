#include "test_harness__CAST_SCAT_server.hh"


extern "C" {
  cast::CASTComponentPtr
  newComponent() {
    return new test_harness__CAST_SCAT_server();
  }
}

test_harness__CAST_SCAT_server::test_harness__CAST_SCAT_server(const Designator&designator)
    :Implement(designator)
{
}


void test_harness__CAST_SCAT_server::configure(const std::map<std::string,std::string>& arguments)
{
...
void test_harness__CAST_SCAT_server::runComponent()
{
}

void test_harness__CAST_SCAT_server::implement__computeFibonacci(testHarnessCASTSCAT::computeFibonacciPtr& input)
{
...
void test_harness__CAST_SCAT_server::start()
{
    implement<testHarnessCASTSCAT::helloWorld>(&test_harness__CAST_SCAT_server::implement__helloWorld);
    
    implement<testHarnessCASTSCAT::computeFibonacci>(&test_harness__CAST_SCAT_server::implement__computeFibonacci);
