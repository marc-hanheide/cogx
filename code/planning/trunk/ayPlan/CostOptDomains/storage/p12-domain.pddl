...
(:action move
 ...
 :effect (and (not (at ?h ?from)) (at ?h ?to) (not (clear ?to)) (clear ?from)(increase (total-cost) 1)
 )
 )
...
(:action go-out
 ...
 :effect (and (not (at ?h ?from)) (at ?h ?to) (clear ?from)(increase (total-cost) 1)
 )
 )
...
(:action go-in
 ...
 :effect (and (not (at ?h ?from)) (at ?h ?to) (not (clear ?to))(increase (total-cost) 1)
 )
 )
)
