...
extern "C" void gpuCensusImageSetup(unsigned int w, unsigned int h, unsigned int disp_min=0, unsigned int disp_max=180, unsigned int disp_step=1, bool sparse = true, unsigned int blockSize = 5);
