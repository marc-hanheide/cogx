...
public class UncertainSuperFormula extends SuperFormula
{
    public UncertainSuperFormula()
    {
        super();
    }

    public UncertainSuperFormula(String id, float prob)
    {
        super(id);
        this.prob = prob;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type beliefmodels::domainmodel::cogx::UncertainSuperFormula was not generated with stream support";
        throw ex;
    }
