...
public final class ComplexFormulaPrxHelper extends Ice.ObjectPrxHelperBase implements ComplexFormulaPrx
{
    ...
    checkedCast(Ice.ObjectPrx __obj)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::beliefmodels::domainmodel::cogx::ComplexFormula"))
                {
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::beliefmodels::domainmodel::cogx::ComplexFormula", __ctx))
                {
                    ComplexFormulaPrxHelper __h = new ComplexFormulaPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::beliefmodels::domainmodel::cogx::ComplexFormula"))
                {
                    ComplexFormulaPrxHelper __h = new ComplexFormulaPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::beliefmodels::domainmodel::cogx::ComplexFormula", __ctx))
                {
                    ComplexFormulaPrxHelper __h = new ComplexFormulaPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
