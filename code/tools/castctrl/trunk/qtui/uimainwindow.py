...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget = QtGui.QWidget(self.tabOldInterface)
        self.widget.setGeometry(QtCore.QRect(50, 160, 258, 41))
        self.widget.setObjectName("widget")
        self.horizontalLayout_6 = QtGui.QHBoxLayout(self.widget)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.btBuild = QtGui.QPushButton(self.widget)
        self.btBuild.setObjectName("btBuild")
        self.horizontalLayout_6.addWidget(self.btBuild)
        self.btBuildInstall = QtGui.QPushButton(self.widget)
        ...
        self.btCmakeGui = QtGui.QPushButton(self.widget)
