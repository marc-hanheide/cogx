...
#
# Created: Thu Apr 22 17:54:29 2010
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/res/system-run.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actStartCastServers.setIcon(icon)
        self.actStartCastServers.setObjectName("actStartCastServers")
        self.actStopCastServers = QtGui.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/res/system-suspend.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actStopCastServers.setIcon(icon1)
        self.actStopCastServers.setObjectName("actStopCastServers")
        self.actStartCastClient = QtGui.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/res/cogxStart.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actStartCastClient.setIcon(icon2)
        self.actStartCastClient.setObjectName("actStartCastClient")
        self.actStopCastClient = QtGui.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/res/cogxStop.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actStopCastClient.setIcon(icon3)
        self.actStopCastClient.setObjectName("actStopCastClient")
        self.actStartExternalServers = QtGui.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/res/go-up.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actStartExternalServers.setIcon(icon4)
        self.actStartExternalServers.setObjectName("actStartExternalServers")
        self.actStopExternalServers = QtGui.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/res/go-down.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actStopExternalServers.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/res/shellscriptOff.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon6.addPixmap(QtGui.QPixmap(":/icons/res/shellscriptOn.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actEnableCleanupScript.setIcon(icon6)
        self.actEnableCleanupScript.setObjectName("actEnableCleanupScript")
        self.actRunMake = QtGui.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/res/svn-update.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actRunMake.setIcon(icon7)
        self.actRunMake.setObjectName("actRunMake")
        self.actRunMakeInstall = QtGui.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/res/svn-commit.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actRunMakeInstall.setIcon(icon8)
        self.actRunMakeInstall.setObjectName("actRunMakeInstall")
        self.actRunMakeClean = QtGui.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/res/runMakeClean.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actRunMakeClean.setIcon(icon9)
        self.actRunMakeClean.setObjectName("actRunMakeClean")
        self.actConfigureWithCMake = QtGui.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/res/CMakeSetup128.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actConfigureWithCMake.setIcon(icon10)
