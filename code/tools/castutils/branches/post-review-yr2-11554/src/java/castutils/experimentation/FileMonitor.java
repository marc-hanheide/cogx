...
public class FileMonitor {
	...
	public void addListener(FileListener fileListener) {
		...
		for (Iterator<WeakReference<FileListener>> i = listeners_.iterator(); i
				.hasNext();) {
			WeakReference<FileListener> reference = (WeakReference<FileListener>) i
					.next();
	...
	private class FileMonitorNotifier extends TimerTask {
		public void run() {
			...
			for (Iterator<File> i = files.iterator(); i.hasNext();) {
				...
				//System.out.println("check file " + file + "lMT = " + lastModifiedTime + " nMT = " + newModifiedTime);
				...
				if (newModifiedTime != lastModifiedTime) {
					...
					for (Iterator<WeakReference<FileListener>> j = listeners_
							.iterator(); j.hasNext();) {
						WeakReference<FileListener> reference = (WeakReference<FileListener>) j
								.next();
						FileListener listener = (FileListener) reference.get();
	...
	public static void main(String args[]) {
		...
		monitor.addFile(new File("/tmp/test.txt"));
