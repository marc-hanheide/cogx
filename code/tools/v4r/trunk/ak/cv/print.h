...
#ifndef CVEXT_PRINT_H
#define CVEXT_PRINT_H
...
* @param pInfo
**/
inline void cvPrint ( const cv::Mat &rMatix, const char *pInfo = NULL) {
...
**/
template <typename T, int cn>
inline void cvPrint ( const cv::Vec<T, cn> &r, const char *pInfo = NULL) {
    if ( pInfo != NULL ) {
        printf ( "%s = ", pInfo);
    }
    printf ( "[%-12.4f", r[0]  );
...
* @param pInfo
**/
inline void cvPrint ( const cv::Point_<int> &p, const char *pInfo = NULL) {
    if ( pInfo != NULL ) {
        printf ( "%s = ", pInfo);
    }
...
* @param pInfo
**/
inline void cvPrint ( const cv::Point_<float> &p, const char *pInfo = NULL) {
    if ( pInfo != NULL ) {
        printf ( "%s = ", pInfo);
    }
...
* @param pInfo
**/
inline void cvPrint ( const cv::Point_<double> &p, const char *pInfo = NULL) {
    if ( pInfo != NULL ) {
        printf ( "%s = ", pInfo);
    }
    printf("[ %-12.4f, %-12.4f ]\n", p.x , p.y);
...
* @param pInfo
**/
inline void cvPrint ( const CvPoint3D64f &rPoint, const char *pInfo = NULL) {
    if ( pInfo != NULL ) {
        printf ( "%s = ", pInfo);
    }
...
* @param pInfo
**/
inline void cvPrint ( const CvPoint2D64f &rPoint, const char *pInfo = NULL ) {
