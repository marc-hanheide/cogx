...
#include <v4r/edgelinker/edgelinker.h>
...
int main(int argc, char *argv[]) {
    ...
    cv::Mat imgGauss, imgCanny, imgGradient, imgDirection, imgLinkedEdges;
	...
	el.Perform(imgCanny, imgGradient, imgDirection);
	el.Draw(imgLinkedEdges);
