...
bool tgTexture1D::Load(void* data, int width, GLenum internal, GLenum format, GLenum type){
	m_width = width;
...
bool tgTexture2D::Load(void* image_data, int width, int height, GLenum internal, GLenum format, GLenum type){
	m_width = width;
	m_height = height;
	m_intFormat = internal;
	glBindTexture(GL_TEXTURE_2D, m_texture_id);
...
bool tgTexture3D::Load(void* data, int width, int height, int depth, GLenum internal, GLenum format, GLenum type){
	m_width = width;
	m_height = height;
	m_depth = depth;
	m_intFormat = internal;
