 ...
 * MeanShiftCodebook
 */
class MeanShiftCodebook : public Codebook
{
public:
  class Parameter
  {
  public:
    float thrDesc;                    // threshold for matching descriptors (0.4)
    ...
    Parameter(float _thrDesc=0.3, float _sigmaDesc=0.1, float nnr=0.8, bool flann=false, int _numTrees=4, int depth=64)
...
public:
  ...
  MeanShiftCodebook(cv::Ptr<cv::DescriptorMatcher> &descMatcher, Parameter _param = Parameter());
  ~MeanShiftCodebook();
