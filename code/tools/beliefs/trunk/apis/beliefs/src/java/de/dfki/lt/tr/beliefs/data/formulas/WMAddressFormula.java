 ...
 * @version 100521
 */
public class WMAddressFormula extends GenericFormula<PointerFormula> {

	public static WMAddressFormula create(Ice.Object pd) {
		return new WMAddressFormula(pd);
	}
	
	public static WMAddressFormula create(WorkingMemoryAddress v) {
		return new WMAddressFormula(new PointerFormula(-1, v));
	}
	 ...
	 * probability.
	 */
	protected WMAddressFormula(Ice.Object formula) {
