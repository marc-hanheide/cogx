...
protected:
	...
	bool create(const Robot::Desc& desc) {
		...
		if (pRetinaObject == NULL)
			throw Message(Message::LEVEL_CRIT, "Robot::create(): Unable to create finger retina object");
...
public:
	...
	/** Process data */
	bool read(golem::RetinaOut &out, SecTmReal &timeStamp, MSecTmU32 timeOut = MSEC_TM_U32_INF);
};
