...
set DIRLIBS=%OPENCCG_LIB%\trove.jar;%OPENCCG_LIB%\jdom.jar;%OPENCCG_LIB%\jline.jar
...
set JAVA_CMD=%JAVA% -Xmx196m -classpath %CP%
rem set JAVA_CMD=%JAVA% -Xmx128m -classpath %CP%
