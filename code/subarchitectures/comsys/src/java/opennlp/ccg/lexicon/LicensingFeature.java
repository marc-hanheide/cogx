 ...
 * @version     $Revision: 1.6 $, $Date: 2008/08/26 05:24:57 $
 */
public class LicensingFeature
{
     ...
     */
    public final List alsoLicensedBy;
    ...
    public LicensingFeature(
        String attr, String val, List alsoLicensedBy, 
        boolean licenseEmptyCats, boolean licenseMarkedCats, boolean instantiate, 
        byte loc
    ) 
    {
        this.attr = attr; this.val = val;
        this.alsoLicensedBy = (alsoLicensedBy != null) ? alsoLicensedBy : Collections.EMPTY_LIST;
