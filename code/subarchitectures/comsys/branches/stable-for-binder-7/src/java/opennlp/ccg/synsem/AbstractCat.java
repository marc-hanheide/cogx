 ...
 * @version     $Revision: 1.15 $, $Date: 2006/09/29 06:55:40 $ 
 */
public abstract class AbstractCat implements Category { 
    ...
    private int _hashCodeNoLF = -1;
    
    /** The mapping from vars to ints, if already computed. */
    private TObjectIntHashMap _varMap = null;
     ...
     * The implementation calls hashCode(varMap) and 
     * caches the result.
     */
    public int hashCode() {
        if (_varMap != null) { return _hashCode; }
    ...
    public int hashCodeNoLF() {
        if (_varMap != null) { return _hashCodeNoLF; }
        hashCode();
