 ...
 * @version     $Revision: 1.60 $, $Date: 2008/01/07 22:57:31 $
 */
public class Chart
{
    ...
    /** Flag for whether to join best fragments if no complete realization found.  Defaults to true. */
     ...
     * search is done.
     * Otherwise, the search is stopped either when the time limit (if any) is reached, 
     * or first complete edge is found (if beyond the time limit, and according to the given flag), 
    ...
    private void joinBestFragments() {
