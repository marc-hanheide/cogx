...
configuration files.
%
\todo{TODO: Apply the settings from persistent storage at startup when a component
registers a form}
%
\todo{TODO: Add config param to DS to change the location of persistent storage}
%
\todo{TODO: Add menu entry to change the location of persistent storage}
%
\todo{TODO: Add widgets to load/save all forms on a page}
...
enclosed in the \code{"<form>"} tag which is added by the Display Server.
