...
-a perl script merge.pl used by build-moloko to combine 
 these .ccg files to create moloko.ccg
-The folder docs containing:
            -the most reason documentation (pdf + latex files)		
