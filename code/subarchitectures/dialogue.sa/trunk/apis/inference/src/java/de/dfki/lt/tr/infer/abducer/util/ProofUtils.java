...
public abstract class ProofUtils {
	 ...
	 * @return the proof
	 */
	public static ArrayList<MarkedQuery> newUnsolvedProof(ModalisedAtom goal) {
		ArrayList<MarkedQuery> result = new ArrayList<MarkedQuery>();
	...
	/**
	 * Return the functor of a term.
	 *
	 * @param t term
	 * @return for function terms: functor of t, for other: <tt>null</tt>
	 */
