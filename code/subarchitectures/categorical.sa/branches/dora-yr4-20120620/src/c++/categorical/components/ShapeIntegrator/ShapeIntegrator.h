/**
 * ShapeIntegrator class.
 * \file ShapeIntegrator
 ...
 */
class CategoricalShapeIntegrator: public cast::ManagedComponent
{
public: // Component management

	/** Constructor. */
	CategoricalShapeIntegrator();

	/** Destructor. */
	virtual ~CategoricalShapeIntegrator();
