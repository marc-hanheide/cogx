...
#ifndef __OSCAR_FEATURE19_2__
#define __OSCAR_FEATURE19_2__
...
// class Feature
//-----------------------------------------
class Feature19_2: public Feature {
    ...
    public:
		...
		void test() { cerr << "Feature19_2::test()" << endl; }
