...
\[
\begin{array}{l}
s_0 \equiv \{(=(\pp{is-in}~\pp{DORA})~\pp{kitchen}),\\
...
state of sequential planning. Second, if the truth value of $\prop$ is
not known, and no assumption is made about it in the current abstract
