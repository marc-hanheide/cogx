...
\section{Sequential Planning in Determinisations}
...
under uncertainty using systems that were intended for sequential planning
...
\system{FF}~\cite{hoffmann:nebel:2001} to compute a sequential plan and
...
planning ---i.e., sequential planning in unobservable worlds--- can be
modelled as a deterministic problem, and therefore solved using sequential
...
planning. Given a POMDP model of the environment, sequential planning is
