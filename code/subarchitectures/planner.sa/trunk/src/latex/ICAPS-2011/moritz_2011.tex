...
that in a continual framework uses the fast satisficing procedure
\system{FF}~\cite{hoffmann:nebel:2001} to compute a sequential plan
and corresponding execution trace. 
%%
