...
according to a recursive descent. Here, an atom is visited if its
conjunctive parent is visited, and a conjunctive term is visited if
all its immediate subterms are visited. A probabilistic term is
