...
\newcommand{\switchAction}{\ensuremath{\tilde{a}}}
...
\newcommand{\poss}{\ensuremath{\pp{pre}}}
...
\newcommand{\assumptiveS}[1]{\actions^{\circ}(\prob_{#1};T_{#1})}
\newcommand{\assumptiveDT}[1]{\actions^{\bullet}(\prob_{#1};T_{#1})}
