...
multi-goal-oriented POMDPs%% \footnote{In the case of finite-horizon
%% planning, POMDPs with stochastic actions can be compiled into
%% equivalent deterministic-action POMDPs, where all the original action
%% uncertainty is expressed in the starting-state
