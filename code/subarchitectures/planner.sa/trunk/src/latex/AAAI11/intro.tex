...
%%
In particular, detailed models of noisy sensing and state should yield
more efficient and robust deliberations.
%%
...
classical procedures, which is also able to synthesise relatively
efficient deliberations according to detailed probabilistic models.
