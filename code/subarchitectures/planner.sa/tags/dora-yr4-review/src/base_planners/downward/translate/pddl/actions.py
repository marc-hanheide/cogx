...
class Action(object):
    def __init__(self, name, parameters, precondition, replan, effects, cost):
        self.name = name
    ...
    def parse(alist):
        ...
        for rest in iterator:
            assert False, rest
        return Action(name, parameters, precondition, replan, eff, cost)
...
class PropositionalAction:
    def __init__(self, name, precondition, replan, effects, cost):
        self.name = name
        self.precondition = precondition
        self.replan = replan
        self.add_effects = []
