 ...
 * 
 */
public class OpenGripperPart extends StrategyPart implements Observer {

	private Logger logger = Logger.getLogger(this.getClass());

	public OpenGripperPart(Manipulator manipulator, Strategy globalStrategy) {
		setManipulator(manipulator);
		setGlobalStrategy(globalStrategy);
		setPartName(PartName.OPEN_GRIPPER_PART);
	}
	...
	public void execute() {
		...
		OpenGripperCommand currentCom = ((OpenGripperCommand) ((CommandExecution) getGlobalStrategy())
				.getCurrentCommand());
