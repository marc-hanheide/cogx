 ...
 * 
 */
public class CogXLocalMapConnector implements MapConnector {
	 ...
	 *            current manipulator
	 */
	public CogXLocalMapConnector(Manipulator manipulator) {
		this.manipulator = manipulator;

		try {
			localMapInterface = ((CogXRunner) manipulator.getRunner())
	...
	public void updateMap() throws ExternalMemoryException {
		try {
			...
			allPlaces = ((CogXRunner) manipulator.getRunner())
