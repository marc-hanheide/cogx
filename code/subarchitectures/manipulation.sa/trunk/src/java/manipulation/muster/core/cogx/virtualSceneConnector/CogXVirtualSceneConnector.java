...
import manipulation.muster.core.cogx.virtualSceneConnector.initObjects.ArmDescI;
import manipulation.muster.core.cogx.virtualSceneConnector.initObjects.BoxShapeDescI;
import manipulation.muster.core.cogx.virtualSceneConnector.initObjects.KatanaArmDescI;
import manipulation.muster.core.cogx.virtualSceneConnector.initObjects.PlaneShapeDescI;
import manipulation.muster.core.cogx.virtualSceneConnector.initObjects.RigidBodyDescI;
...
import manipulation.muster.core.share.types.ModelPoint;
...
import manipulation.muster.core.share.types.VisionModel;
...
public class CogXVirtualSceneConnector implements VirtualSceneConnector {
	...
	public void addBox(Matrix rotation) {
		...
		obstacle.globalPose.R = CogXConverter.convMatrixToGolem(rotation);
