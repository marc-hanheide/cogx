...
pdf_out.suffStat = kde_aug.pdf.suffStat ;
kde_aug.pdf = pdf_out ; 
kde_aug.pdf.suffStat.A = kde_aug.pdf.suffStat.A(idx_valid) ;
kde_aug.pdf.suffStat.B = kde_aug.pdf.suffStat.B(idx_valid) ;
kde_aug.pdf.suffStat.subLayer = kde_aug.pdf.suffStat.subLayer(idx_valid) ;
