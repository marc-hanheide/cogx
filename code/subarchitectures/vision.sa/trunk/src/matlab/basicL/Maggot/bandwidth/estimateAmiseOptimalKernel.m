...
for i = 1:2:nargs
    switch args{i}        
        ...
        case 'max_ibw_iterations', max_ibw_iterations = args{i+1} ; 
        ...
        case 'accountForVirginComponents', accountForVirginComponents = args{i+1} ;
        case 'MDL_guides', MDL_guides = args{i+1} ;
        case 'backAdjustDerivative', backAdjustDerivative = args{i+1} ;
        case 'readjustCompsInFinalModel', readjustCompsInFinalModel = args{i+1} ;
        case 'useSublayerForDerivativeModel', useSublayerForDerivativeModel = args{i+1} ;
...
%       ikdeParams.suffSt.K_eff = (1/K_eff_t_1)*v1^2 + (1-v1)^2*sum(obs_relative_weights.^2) ;
