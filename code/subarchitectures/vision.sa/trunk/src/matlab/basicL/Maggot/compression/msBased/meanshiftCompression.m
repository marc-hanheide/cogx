...
% Last revised: 2009
%%
function [ pdf2 ] = meanshiftCompression( pdf, varargin )
...
[centers, id_converged, threshStop ] = findModesOnMixture( reference_pdf ) ;
clustersID = clusterdata(centers','distance', 'euclidean', 'linkage', 'centroid', 'cutoff', threshStop/2, 'criterion', 'distance') ;
