...
int main ( int argc, char** argv ) 
{
  ...
  Matrix C(3,3);
  C(1,1) = 596.561604; C(1,2) = 0;  C(1,3) = 353.497082 ;
  C(2,1) = 0;  C(2,2) = 597.739272; C(2,3) = 226.281385;
  ...
  for (;;) {
    ...
    }else if (keys.Size()>0 && !firstRun)
    {
      ...
      if(odetect.Detect(keys, &object))
      {
        ...
        cout<<object.pose.R<<object.pose.t;
      }
    }
