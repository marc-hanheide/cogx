...
// converts a tracker pose (x,y,z,alpha,beta,gamma) to a pose (R, t) 
bool convertTrackerPose2Pose(Pose& tp, Pose3& pose){
	mat3 rot;
	vec3 pos;
...
// converts a pose (R, t) to a tracker pose (x,y,z,alpha,beta,gamma)
bool convertPose2TrackerPose(Pose3& pose, Pose& tp){
	mat3 rot;
	vec3 pos;
