...
% --- Executes on button press in pb_nextTell.
function pb_nextTell_Callback(hObject, eventdata, handles)
% hObject    handle to pb_nextTell (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in pb_nextAsk.
function pb_nextAsk_Callback(hObject, eventdata, handles)
% hObject    handle to pb_nextAsk (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
