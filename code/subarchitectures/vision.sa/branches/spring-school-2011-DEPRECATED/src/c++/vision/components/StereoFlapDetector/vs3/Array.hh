/**
 * $Id: Array.hh,v 1.20 2007/02/25 18:41:58 mxz Exp mxz $
 */
...
public:
  ...
  unsigned CircularNext(unsigned i) const throw(Except);
  unsigned CircularPrev(unsigned i) const throw(Except);
