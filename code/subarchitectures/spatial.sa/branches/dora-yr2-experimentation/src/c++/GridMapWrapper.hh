   ...
   */
   template <class Data>
      struct GridMapWrapper {
         ...
         GridMapWrapper(){};
         GridMapWrapper(Data data) : data(data) {};
   ...
   template <class Data>
      inline std::ostream& operator << (std::ostream& stream, const GridMapWrapper<Data> & wrapper)
      {
         stream << wrapper.data << " ";
         return stream; 
      }
   ...
   template <class Data>
      inline std::istream& operator >> (std::istream& stream, GridMapWrapper<Data> & wrapper)
      {
         stream >> wrapper.data;
         return stream; 
      }
