...
namespace SpatialGridMap {
    ...
    */
    class GDProbMax{
        private:
            ...
            double result;
        public:
            static FunctorType type() { return Read; }
            GDProbMax() { reset(); };
            inline void operator()(const GridMapData & data, double size, double xPos, double yPos, double zPos){
                if(first) { 
                    result = data.pdf; 
                    first = false;
                } else { 
    ...
    */
    ...
    class GDMeasUpdateGetDenominator{
        ...
        public:
            static FunctorType type() { return Read; }
            GDMeasUpdateGetDenominator(double sensorDetectionProb, double probDensitySum): sensorDetectionProb(sensorDetectionProb), denominator(probDensitySum) {};
            inline void operator()(const GridMapData & data, double size, double xPos, double yPos, double zPos){
	      denominator -= data.pdf * size * sensorDetectionProb;
	    };
            double getResult() const { return denominator; };
    };   
    ...
    */
    class GDUnsuccessfulMeasUpdate{
        ...
        public:
            static FunctorType type() { return Split; }
            GDUnsuccessfulMeasUpdate(double denominator,double sensorDetectionProb): denominator(denominator), sensorDetectionProb(sensorDetectionProb) { };
            inline void operator()(GridMapData & data, double size, double xPos, double yPos, double zPos){
    ...
    */
    class GDSet{
        private:
            GridMapData value;
        public:
            static FunctorType type() { return Replace; }
            GDSet(GridMapData value) : value(value) {};
            void setValue(GridMapData value) { this->value = value; }
            inline void operator()(GridMapData & data, double size, double xPos, double yPos, double zPos) const {
                data = value;
            };
    };
    ...
    */
    class GDProbSet{
        ...
        public:
            static FunctorType type() { return Replace; }
            GDProbSet(double value) : value(value) {};
    ...
    */
    class GDProbInit{
	    ...
	    double total;
        public:
            static FunctorType type() { return Iterate; }
            GDProbInit(double value) : value(value), total(0.0) {};
    ...
    class GDProbScale{
        ...
        public:
            static FunctorType type() { return Iterate; }
            GDProbScale(double factor) : factor(factor) {};
    ...
    */
    class GDProbAdd{
        ...
        public:
            static FunctorType type() { return Iterate; }
            GDProbAdd(double value) : value(value) {};
            void setValue(double value) { this->value = value; }
            inline void operator()(GridMapData & data, double size, double xPos, double yPos, double zPos) const {
                data.pdf += value;
            };
    ...
    class GDMakeFree{
        public:
            static bool type() { return Iterate; }
            inline void operator()(GridMapData & data, double size, double xPos, double yPos, double zPos) const {
                data.occupancy = FREE;
            };
    };
    ...
    class GDSplitZMult {
        ...
        public:
            static FunctorType type() { return Split; }
            GDSplitZMult(double value) : value(value) {};
            inline void operator()(GridMapData & data, double size, double xPos, double yPos, double zPos) {
                data.pdf = value * zPos;
            };
            void setValue(double value) { this->value = value; }
    ...
    */
    ...
    inline double
      normalizePDF(GridMap<GridMapData> & map, double pTarget, double currentWeight = 0.0) {
