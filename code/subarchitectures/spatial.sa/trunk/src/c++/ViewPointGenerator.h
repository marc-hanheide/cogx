...
public:
  ...
  ViewPointGenerator(AVS_ContinualPlanner* component, CureObstMap* plgm,
      BloxelMap* pbloxelmap, int samplesize, 
      size_t maxViewConeCount, double sampleawayfromobs,
      double conedepth, double tiltstep, double panstep, double horizangle,
      double vertangle, double minDistance, 
      double minConeProb, double minRelativeConeProb,
      double pdfsum, double pdfthreshold,
