...
// ------------------------------------------------------
bool DataWriter::writeImage(const PlaceData::ImagePtr image, Format format)
{
  // Create directory
...
// ------------------------------------------------------
bool DataWriter::copyImage(std::string sourceImage, const PlaceData::ImagePtr image)
{
  // Create directory
  path p=getImagesDirPath();
  try
...
// ------------------------------------------------------
bool DataWriter::writeLaserScan(const PlaceData::LaserScanPtr scan)
{
...
// ------------------------------------------------------
bool DataWriter::writeOdometry(const PlaceData::OdometryPtr odom)
{
...
// ------------------------------------------------------
bool DataWriter::writePgmImage(const PlaceData::ImagePtr image, std::string path)
{
