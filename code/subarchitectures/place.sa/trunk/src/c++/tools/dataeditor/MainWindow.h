...
private:
  ...
  place::OdomScanWidget *_osWidget;
...
private:
  ...
  struct Image
  {
    PlaceData::ImagePtr image;
    QString path;
  };

  QVector<Image> _images;
  QVector<PlaceData::LaserScanPtr> _scans;
  QVector<PlaceData::OdometryPtr> _odoms;
  QVector<PlaceData::TargetPtr> _targets;
