...
// Old dummy structures for Visual Learning

    struct RecognizedAttributes
    {
      cast::cdl::WorkingMemoryAddress targetAddress;
      Matlab::Matrix attributes;
      Matlab::Matrix probableAttributes;
    ...
    // or the robot itself (in case of tutor supervised learning).
      bool tutorInitiated;
      cast::cdl::WorkingMemoryAddress targetAddress;
//      IntWithConfidenceSequence features;
      string type; 
//    IntSequence features;
    };
