#ifndef BINDING_LINEOFSIGHT_HELPER_H_
#define BINDING_LINEOFSIGHT_HELPER_H_
...
class LineOfSightHelper : public FeatureHelper<BindingFeatures::LineOfSight> {
public:
  LineOfSightHelper();
...
#endif // BINDING_LINEOFSIGHT_HELPER_H_
