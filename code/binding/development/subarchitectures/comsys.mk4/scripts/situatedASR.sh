clear
echo  ========================================================
echo  Comsys.mk4 [ situated speech recognition ]
echo  --------------------------------------------------------
...
date
echo  ========================================================
java -Xmx2000m -Djava.library.path=$CODE_HOME/output/lib -classpath $CLASSPATH:$PELLET_ROOT/lib/pellet.jar:$PELLET_ROOT/lib/aterm-java-1.6.jar:$OWLAPI_ROOT/lib/owlapi-api.jar:$OWLAPI_ROOT/lib/owlapi-apibinding.jar:$CODE_HOME/output/classes/:$CODE_HOME/tools/openccg/lib/ cast.server.CASTProcessServer -h localhost -f $CODE_HOME/subarchitectures/comsys.mk4/config/situatedASR.cast
