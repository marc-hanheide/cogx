...
/** 
The class <b>MFrequencyProxyFactory</b> implements the  mapping 
for producing a proxy, or a collection of proxies and proxy relations, 
for M-FREQUENCY type nominals. No such proxies are created. 
...
public class MFrequencyProxyFactory 
	...
	
{
	...
	public MFrequencyProxyFactory () { 
		super();
		rootSort = "m-frequency";
	} // end
