	...
	
{
	...
	protected void addBasicContent (PackedNominal nom) { 
		...
		proxyStructure.setFeature("Name",nom.prop.prop);
		log("Name: ["+nom.prop.prop+"]");
		// use the proposition as the a-modal concept
		if (nom.prop.prop.equals("you")) { 
			proxyStructure.setFeature("Concept","addressee"); // bad hack :( 
		} else { 
			proxyStructure.setFeature("Concept","person");			
		} 
