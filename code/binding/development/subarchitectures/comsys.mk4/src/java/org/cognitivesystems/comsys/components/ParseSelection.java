...
import org.cognitivesystems.comsys.processing.parseselection.*;
...
public class ParseSelection 
     ...
     * @param _id
     */
    public ParseSelection (String _id) {
        super(_id);
    } // constructor/1
	...
	*/ 
    ...
    public void configure(Properties _config) {
        ...
        if (_config.containsKey("--parameterfile")) {
           String parameterfile  = _config.getProperty("--parameterfile");
       ...
       //    log("Parameter vector: " + params.toString());
        ...
        if (_config.containsKey("--asr-correction")) {
            String asrcorrectionStr  = _config.getProperty("--asr-correction");
        ...
        if (_config.containsKey("--disfluency-correction")) {
            String disflcorrectionStr  = _config.getProperty("--disfluency-correction");
        ...
        if (_config.containsKey("--discourse-level-composition")) {
            String disclevelcompStr  = _config.getProperty("--discourse-level-composition");
   ...
   // 	log("starting executeParseSelectionTask...");
    	try {	
            ...
            if (plfWM != null) {
                ...
                //		LFUtils.plfToGraph(plf.packedLF, "parsesel", true);
                   		recogString = "";
                		addToWorkingMemory(newDataID(),lf,OperationMode.BLOCKING);
                	}
                	else {
                	...
                	addToWorkingMemory(newDataID(),selectedLF,OperationMode.BLOCKING);
                	}
                }
                else {
    ...
    public void runComponent() {
        try {
            ...
            lockProcess();
            sleepProcess(100); // plison - give enough time for other
                        ...
                        if (taskType != null && data != null) {
                            ...
                            try {
                                if (taskType
                                    ...
                                    log("Unknown task type to process in Comsys:parseSelection component");
