...
date
echo  ========================================================
java -Xmx2000m -ea -classpath lib/nsc.jar:lib/vcomsc.jar:./output/classes/ cast.server.CASTProcessServer -h 127.0.0.1 -f ./subarchitectures/comsys.mk4/config/speechrec.cast
