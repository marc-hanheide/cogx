 ...
 * @author nah
 */
public class BackProjectiveMap extends ProjectiveMap {


    /**
     * The constructor needs to specify the bounding box of the scene.
     */
    public BackProjectiveMap(float _blx, float _bly, float _trx,
            float _try) {
        super(_blx, _bly, _trx, _try, ProjectiveDirection.BACK);
    }
