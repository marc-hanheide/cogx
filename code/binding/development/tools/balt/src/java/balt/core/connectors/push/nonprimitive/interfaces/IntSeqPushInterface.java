 ...
 * @author nah
 */
public interface IntSeqPushInterface {

    public interface IntSeqSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                IntSeqPushInterface.IntSeqPushConnectorOut _out);

    }

    public interface IntSeqPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, int[] _o);
    }

    public interface IntSeqPushConnectorRegister extends
         ...
         *            this connector.
         */
        public abstract void registerPushReceiver(IntSeqPushReceiver _pr);
    }

    public interface IntSeqPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, int[] _data);
    }

    public interface IntSeqPushConnector extends PushConnector,
            IntSeqPushConnectorOut, IntSeqPushConnectorRegister {
