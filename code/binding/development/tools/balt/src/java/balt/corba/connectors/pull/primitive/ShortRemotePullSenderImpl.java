 ...
 * @author nah
 */
public class ShortRemotePullSenderImpl extends RemotePullSenderPOA
        implements ShortPullInterface.ShortPullConnectorOut {
     ...
     * 
     */
    public ShortRemotePullSenderImpl() {
        super();
    }
    ...
    public short pull(FrameworkQuery _query)
        ...
        if (m_out != null) {
            try {
                return RemoteDataTranslator.translateShortFromAny(m_out
