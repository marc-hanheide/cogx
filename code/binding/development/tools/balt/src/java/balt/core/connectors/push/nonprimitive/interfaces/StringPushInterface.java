 ...
 * @author nah
 */
public interface StringPushInterface {

    public interface StringPushConnector extends PushConnector,
            StringPushInterface.StringPushConnectorOut,
            StringPushInterface.StringPushConnectorRegister {

    }

    public interface StringPushConnectorOut extends PushConnectorOut {
    ...
    public interface StringPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                StringPushInterface.StringPushReceiver _pr);
    }

    public interface StringPushReceiver extends PushReceiver {
    ...
    public interface StringPushSender extends PushSender {
