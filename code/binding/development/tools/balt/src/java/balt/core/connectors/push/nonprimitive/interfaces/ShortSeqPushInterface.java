 ...
 * @author nah
 */
public interface ShortSeqPushInterface {

    public interface ShortSeqSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                ShortSeqPushInterface.ShortSeqPushConnectorOut _out);

    }

    public interface ShortSeqPushReceiver extends PushReceiver {
    ...
    public interface ShortSeqPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                ShortSeqPushReceiver _pr);
    }

    public interface ShortSeqPushConnectorOut extends PushConnectorOut {
    ...
    public interface ShortSeqPushConnector extends PushConnector,
            ShortSeqPushConnectorOut, ShortSeqPushConnectorRegister {
