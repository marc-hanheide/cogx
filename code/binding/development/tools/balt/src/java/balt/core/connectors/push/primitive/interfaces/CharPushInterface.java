 ...
 * @author nah
 */
public interface CharPushInterface {

    public interface CharPushConnector extends PushConnector,
            CharPushConnectorOut, CharPushConnectorRegister {

    }

    public interface CharPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, char _data);
    }

    public interface CharPushConnectorRegister extends
         ...
         *            this connector.
         */
        public abstract void registerPushReceiver(CharPushReceiver _pr);
    }

    public interface CharPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, char _o);
    }

    public interface CharSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                CharPushInterface.CharPushConnectorOut _out);
