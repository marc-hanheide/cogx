 ...
 * @author nah
 */
public interface ShortPushInterface {

    public interface ShortPushConnector extends PushConnector,
            ShortPushConnectorOut, ShortPushConnectorRegister {

    }

    public interface ShortPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, short _data);
    }

    public interface ShortPushConnectorRegister extends
         ...
         *            this connector.
         */
        public abstract void registerPushReceiver(ShortPushReceiver _pr);
    }

    public interface ShortPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, short _o);
    }

    public interface ShortSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                ShortPushInterface.ShortPushConnectorOut _out);
