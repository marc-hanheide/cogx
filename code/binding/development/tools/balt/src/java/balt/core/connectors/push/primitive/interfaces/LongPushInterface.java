 ...
 * @author nah
 */
public interface LongPushInterface {

    public interface LongPushConnector extends PushConnector,
            LongPushConnectorOut, LongPushConnectorRegister {

    }

    public interface LongPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, long _data);
    }

    public interface LongPushConnectorRegister extends
         ...
         *            this connector.
         */
        public abstract void registerPushReceiver(LongPushReceiver _pr);
    }

    public interface LongPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, long _o);
    }

    public interface LongSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                LongPushInterface.LongPushConnectorOut _out);
