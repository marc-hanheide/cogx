 ...
 * @author nah
 */
public interface BytePushInterface {

    public interface BytePushConnector extends PushConnector,
            BytePushConnectorOut, BytePushConnectorRegister {

    }

    public interface BytePushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, byte _data);
    }

    public interface BytePushConnectorRegister extends
         ...
         *            this connector.
         */
        public abstract void registerPushReceiver(BytePushReceiver _pr);
    }

    public interface BytePushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, byte _o);
    }

    public interface ByteSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                BytePushInterface.BytePushConnectorOut _out);
