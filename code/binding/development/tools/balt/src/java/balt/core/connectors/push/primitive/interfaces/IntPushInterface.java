 ...
 * @author nah
 */
public interface IntPushInterface {

    public interface IntPushConnector extends PushConnector,
            IntPushConnectorOut, IntPushConnectorRegister {

    }

    public interface IntPushConnectorOut extends PushConnectorOut {
    ...
    public interface IntPushConnectorRegister extends
         ...
         *            this connector.
         */
        public abstract void registerPushReceiver(IntPushReceiver _pr);
    }

    public interface IntPushReceiver extends PushReceiver {
    ...
    public interface IntSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                IntPushInterface.IntPushConnectorOut _out);
