 ...
 * @author nah
 */
public interface StringSeqPushInterface {

    public interface StringSeqSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                StringSeqPushInterface.StringSeqPushConnectorOut _out);

    }

    public interface StringSeqPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, String[] _o);
    }

    public interface StringSeqPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                StringSeqPushReceiver _pr);
    }

    public interface StringSeqPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, String[] _data);
    }

    public interface StringSeqPushConnector extends PushConnector,
            StringSeqPushConnectorOut, StringSeqPushConnectorRegister {
