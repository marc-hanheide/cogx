...
public class WorkingMemoryEntry extends Ice.ObjectImpl
{
    public WorkingMemoryEntry()
    {
    }

    public WorkingMemoryEntry(String id, String type, int version, Ice.Object entry)
    {
        this.id = id;
        this.type = type;
