 ...
 * @author nah
 */
public interface GPRPushInterface {

    public interface GPRPushConnector extends PushConnector,
            GPRPushInterface.GPRPushConnectorOut,
            GPRPushInterface.GPRPushConnectorRegister {

    }

    public interface GPRPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, TaskResult _data);
    }

    public interface GPRPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                GPRPushInterface.GPRPushReceiver _pr);
    }

    public interface GPRPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, TaskResult _data);
    }

    public interface GPRPushSender extends PushSender {
