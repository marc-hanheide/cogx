...
public interface CASTWorkingMemoryInterface {
     ...
     */
    public abstract Collection<CASTWorkingMemoryItem> getByType(
     ...
     *         id)
     */
    public abstract boolean add(String _id, CASTWorkingMemoryItem _data);
     ...
     */
    public abstract CASTWorkingMemoryItem remove(String _id);
     ...
     */
    public abstract CASTWorkingMemoryItem get(String _id);
