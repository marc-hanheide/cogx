...
public final class _ManagedComponentDelM extends Ice._ObjectDelM implements _ManagedComponentDel
{
    public void
    ...
    setTaskManager(TaskManagerPrx tm, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("setTaskManager", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
                IceInternal.BasicStream __os = __og.os();
                TaskManagerPrxHelper.__write(__os, tm);
            }
            catch(Ice.LocalException __ex)
            {
                __og.abort(__ex);
    ...
    taskDecision(String id, cast.cdl.TaskManagementDecision decision, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("taskDecision", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
