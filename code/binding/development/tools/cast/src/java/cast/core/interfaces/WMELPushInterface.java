 ...
 * @author nah
 */
public interface WMELPushInterface {

    public interface WMELPushConnector extends PushConnector,
            WMELPushInterface.WMELPushConnectorOut,
            WMELPushInterface.WMELPushConnectorRegister {

    }

    public interface WMELPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src,
                WorkingMemoryEntry[] _data);
    }

    public interface WMELPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                WMELPushInterface.WMELPushReceiver _pr);
    }

    public interface WMELPushReceiver extends PushReceiver {
    ...
    public interface WMELPushSender extends PushSender {
