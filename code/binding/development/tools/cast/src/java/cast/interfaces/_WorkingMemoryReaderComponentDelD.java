...
public final class _WorkingMemoryReaderComponentDelD extends Ice._ObjectDelD implements _WorkingMemoryReaderComponentDel
{
    public void
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    WorkingMemoryReaderComponent __servant = null;
                    try
                    {
                        __servant = (WorkingMemoryReaderComponent)__obj;
                    }
