...
public final class _ManagedComponentDelD extends Ice._ObjectDelD implements _ManagedComponentDel
{
    public void
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    ManagedComponent __servant = null;
                    try
                    {
                        __servant = (ManagedComponent)__obj;
                    }
    ...
    public void
    setTaskManager(final TaskManagerPrx tm, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "setTaskManager", Ice.OperationMode.Normal, __ctx);
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __servant.setTaskManager(tm, __current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
    ...
    public void
    taskDecision(final String id, final cast.cdl.TaskManagementDecision decision, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "taskDecision", Ice.OperationMode.Normal, __ctx);
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __servant.taskDecision(id, decision, __current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
