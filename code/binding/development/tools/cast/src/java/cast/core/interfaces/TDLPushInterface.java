 ...
 * @author nah
 */
public interface TDLPushInterface {

    public interface TDLPushConnector extends PushConnector,
            TDLPushInterface.TDLPushConnectorOut,
            TDLPushInterface.TDLPushConnectorRegister {

    }

    public interface TDLPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, TaskDescription[] _data);
    }

    public interface TDLPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                TDLPushInterface.TDLPushReceiver _pr);
    }

    public interface TDLPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, TaskDescription[] _data);
    }

    public interface TDLPushSender extends PushSender {
