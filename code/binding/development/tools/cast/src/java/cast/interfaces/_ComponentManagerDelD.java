...
public final class _ComponentManagerDelD extends Ice._ObjectDelD implements _ComponentManagerDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    ComponentManager __servant = null;
                    try
                    {
                        __servant = (ComponentManager)__obj;
                    }
