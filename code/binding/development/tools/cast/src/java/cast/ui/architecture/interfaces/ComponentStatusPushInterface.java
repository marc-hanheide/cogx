 ...
 * @author nah
 */
public interface ComponentStatusPushInterface {

    public interface ComponentStatusPushConnector extends PushConnector,
            ComponentStatusPushConnectorOut, ComponentStatusPushConnectorRegister {

    }

    public interface ComponentStatusPushConnectorOut extends
            PushConnectorOut {
         ...
         */
        public abstract void push(String _src, ComponentStatus _data);
    }

    public interface ComponentStatusPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                ComponentStatusPushInterface.ComponentStatusPushReceiver _pr);
    }

    public interface ComponentStatusPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src,
                ComponentStatus _data);
    }

    public interface ComponentStatusPushSender extends PushSender {
        ...
        public abstract void setPushConnector(String _connectionID,
                ComponentStatusPushConnectorOut _out);
