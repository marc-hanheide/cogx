...
public abstract class _ComponentManagerDisp extends Ice.ObjectImpl implements ComponentManager
{
    protected void
    ...
    ___getCASTTime(ComponentManager __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
