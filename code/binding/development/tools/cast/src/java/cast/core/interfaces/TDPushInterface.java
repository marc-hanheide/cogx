 ...
 * @author nah
 */
public interface TDPushInterface {

    public interface TDPushConnector extends PushConnector,
            TDPushInterface.TDPushConnectorOut,
            TDPushInterface.TDPushConnectorRegister {

    }

    public interface TDPushConnectorOut extends PushConnectorOut {
    ...
    public interface TDPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                TDPushInterface.TDPushReceiver _pr);
    }

    public interface TDPushReceiver extends PushReceiver {
    ...
    public interface TDPushSender extends PushSender {
