 ...
 * @author nah
 */
public interface WMEPushInterface {

    public interface WMEPushConnector extends PushConnector,
            WMEPushInterface.WMEPushConnectorOut,
            WMEPushInterface.WMEPushConnectorRegister {

    }

    public interface WMEPushConnectorOut extends PushConnectorOut {
         ...
         */
        public abstract void push(String _src, WorkingMemoryEntry _data);
    }

    public interface WMEPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                WMEPushInterface.WMEPushReceiver _pr);
    }

    public interface WMEPushReceiver extends PushReceiver {
         ...
         */
        public abstract void receivePushData(String _src, WorkingMemoryEntry _data);
    }

    public interface WMEPushSender extends PushSender {
