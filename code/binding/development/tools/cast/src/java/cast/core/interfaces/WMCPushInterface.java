 ...
 * @author nah
 */
public interface WMCPushInterface {

    public interface WMCPushConnector extends PushConnector,
            WMCPushInterface.WMCPushConnectorOut,
            WMCPushInterface.WMCPushConnectorRegister {

    }

    public interface WMCPushConnectorOut extends PushConnectorOut {
    ...
    public interface WMCPushConnectorRegister extends
        ...
        public abstract void registerPushReceiver(
                WMCPushInterface.WMCPushReceiver _pr);
    }

    public interface WMCPushReceiver extends PushReceiver {
    ...
    public interface WMCPushSender extends PushSender {
