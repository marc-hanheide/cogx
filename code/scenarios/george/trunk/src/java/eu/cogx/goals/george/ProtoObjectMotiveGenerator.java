...
public class ProtoObjectMotiveGenerator extends
	...
	protected AnalyzeProtoObjectMotive checkForAddition(
		...
		log("checkForAddition(): check belief " + _newEntry.id + " for addition");
		...
		AnalyzeProtoObjectMotive result = new AnalyzeProtoObjectMotive();
	...
	protected AnalyzeProtoObjectMotive checkForUpdate(GroundedBelief _newEntry,
		...
		//assume for now that no update effects the motive
		return _motive;
	}
