...
public class GeorgeExecutionMediator extends BeliefBasedPlanExecutionMediator
	...
	public execution.slice.Action toSystemAction(Action _plannedAction)
		...
		// "ask-for-an-objects-color-general is expected to be of arity 2";
		...
		//
		// assert _plannedAction.arguments.length == 2 :
		// "ask-for-an-objects-shape-general is expected to be of arity 2";
		...
		//
		// assert _plannedAction.arguments.length == 2 :
		// "ask-for-an-objects-ident-general is expected to be of arity 2";
		// return createSingleBeliefAction(AskForIdentity.class,
		// _plannedAction.arguments[1]);
		// } else if
		// (_plannedAction.name.equals("ask-for-an-objects-color-polar")) {
		//
		// assert _plannedAction.arguments.length == 3 :
		// "ask-for-an-objects-color-polar is expected to be of arity 2";
		// return createBeliefPlusStringAction(AskPolarColour.class,
		// _plannedAction.arguments[1], _plannedAction.arguments[2]);
		// } else if
		// (_plannedAction.name.equals("ask-for-an-objects-shape-polar")) {
		//
		// assert _plannedAction.arguments.length == 3 :
		// "ask-for-an-objects-shape-polar is expected to be of arity 2";
		// return createBeliefPlusStringAction(AskPolarShape.class,
		// _plannedAction.arguments[1], _plannedAction.arguments[2]);
		// } else if
		// (_plannedAction.name.equals("ask-for-an-objects-ident-polar")) {
		//
		// assert _plannedAction.arguments.length == 3 :
		// "ask-for-an-objects-ident-polar is expected to be of arity 2";
		// return createBeliefPlusStringAction(AskPolarIdentity.class,
		// _plannedAction.arguments[1], _plannedAction.arguments[2]);
		// } else if (_plannedAction.name.equals("learn-color")) {
		//
		// assert _plannedAction.arguments.length == 3 :
		// "learn-color is expected to be of arity 3";
		...
		//
		// assert _plannedAction.arguments.length == 3 :
		// "learn-shape is expected to be of arity 3";
		...
		//
		// assert _plannedAction.arguments.length == 3 :
		// "learn-ident is expected to be of arity 3";
		...
		// {
		// assert _plannedAction.arguments.length == 2 :
		// "ask-for-and-object-with-color is expected to be of arity 2";
		// return createAskForAction("color",
		// (ElementaryFormula) _plannedAction.arguments[1]);
		// } else if
		// (_plannedAction.name.equals("ask-for-and-object-with-shape")) {
		// assert _plannedAction.arguments.length == 2 :
		// "ask-for-and-object-with-shape is expected to be of arity 2";
		// return createAskForAction("shape",
		// (ElementaryFormula) _plannedAction.arguments[1]);
		// } else if
		// (_plannedAction.name.equals("ask-for-and-object-with-ident")) {
		// assert _plannedAction.arguments.length == 2 :
		// "ask-for-and-object-with-ident is expected to be of arity 2";
