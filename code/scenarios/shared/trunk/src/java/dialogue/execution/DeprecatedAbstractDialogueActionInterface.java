 ...
 * 
 */
public abstract class DeprecatedAbstractDialogueActionInterface extends AbstractActionInterface {
	...
	public static class DirectColourAnswer extends
		...
		public TriBool execute() {
			...
			try {
				((DeprecatedAbstractDialogueActionInterface) getComponent())
	...
	public abstract static class BeliefIntentionDialogueAction<T extends SingleBeliefAction>
		...
		protected Intention getIntention() {
			...
			WorkingMemoryAddress sharedBeliefAddress = ((DeprecatedAbstractDialogueActionInterface) getComponent())
