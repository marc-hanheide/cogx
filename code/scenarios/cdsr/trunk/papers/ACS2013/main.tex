...
%The type 2 trials the same visual stimulus and accompanying spatial descriptions as the type 1 trials with the addition that a location was marked on %the visual stimulus (using a red dot) and the subject was asked to rank on a five point Likert scale their judgement of how well the location matched %the described spatial region. For each stimulus domain (classroom, map, military engagement) three points (P1, P2, and P3) were pre-selected.
