...
43 undergraduate students from two different third level institutes took part in the study. To control for sequence effects the presentation order of the trials were randomised each participant. Also in order to minimise fatigue of the subjects for the Type 2 Likert trials each subject only ranked a randomly selected subset of the trials. 
