...
# 1.36 1.36.0,
# 1.36.1, 1.37.0, 1.37.1, 1.38.0, 1.38.1, 1.39.0, 1.39.1, 1.40.0, 1.40.1
#
...
SET( _boost_TEST_VERSIONS ${Boost_ADDITIONAL_VERSIONS} "1.40.1" "1.40.0" "1.40" "1.39.1" "1.39.0" "1.39" "1.38.1" "1.38.0" "1.38" "1.37.1" "1.37.0" "1.37" "1.36.1" "1.36.0" "1.36" )
  ...
  FOREACH(COMPONENT ${Boost_FIND_COMPONENTS})
    ...
    FIND_LIBRARY(Boost_${UPPERCOMPONENT}_LIBRARY_RELEASE
        NAMES  ${Boost_LIB_PREFIX}boost_${COMPONENT}${_boost_COMPILER}${_boost_MULTITHREADED}-${Boost_LIB_VERSION}
               ...
               ${Boost_LIB_PREFIX}boost_${COMPONENT}${_boost_COMPILER}
